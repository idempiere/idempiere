...
-- Sep 2, 2013 3:22:50 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
ALTER TABLE PA_DashboardContent_Access ADD CONSTRAINT PADashboardContAcc_PADashboard FOREIGN KEY (PA_DashboardContent_ID) REFERENCES pa_dashboardcontent(pa_dashboardcontent_id)
;
...
-- IDEMPIERE-1064 Control dashboard access by role
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,Created,CreatedBy,Updated,IsActive,IsDisplayedGrid,AD_Client_ID,ColumnSpan) VALUES ('N',200112,22,'N','N',210853,10,'Y',202481,'N','A Client is a company or a legal entity. You cannot share data between Clients. Tenant is a synonym for Client.','D','Client/Tenant for this installation.','Client','63ab166f-aaba-4099-9ab4-ed90d34e99c8','Y','N',100,0,TO_TIMESTAMP('2013-09-02 15:33:11','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2013-09-02 15:33:11','YYYY-MM-DD HH24:MI:SS'),'Y','N',0,2)
;

-- Sep 2, 2013 3:33:12 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,IsAllowCopy,UpdatedBy,AD_Org_ID,Created,CreatedBy,Updated,IsActive,XPosition,AD_Client_ID,ColumnSpan) VALUES ('N',200112,22,'N','N',210854,20,'Y',202482,'N','An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.','D','Organizational entity within client','Organization','d3240760-8487-4602-9484-bdb6eb613941','Y','N','Y',100,0,TO_TIMESTAMP('2013-09-02 15:33:11','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2013-09-02 15:33:11','YYYY-MM-DD HH24:MI:SS'),'Y',4,0,2)
;

-- Sep 2, 2013 3:33:12 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,Created,CreatedBy,Updated,IsActive,IsDisplayedGrid,AD_Client_ID,ColumnSpan) VALUES ('N',200112,22,'N','N',210851,30,'Y',202483,'N','D','PA_DashboardContent_Access_ID','a6466b76-49d6-4c79-895f-120445a6e6d6','N','N',100,0,TO_TIMESTAMP('2013-09-02 15:33:12','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2013-09-02 15:33:12','YYYY-MM-DD HH24:MI:SS'),'Y','N',0,2)
;

-- Sep 2, 2013 3:33:13 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,Created,CreatedBy,Updated,IsActive,IsDisplayedGrid,AD_Client_ID,ColumnSpan) VALUES ('N',200112,36,'N','N',210852,40,'Y',202484,'N','D','PA_DashboardContent_Access_UU','763348a5-60df-4679-b0de-737e8ee9cbf0','N','N',100,0,TO_TIMESTAMP('2013-09-02 15:33:12','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2013-09-02 15:33:12','YYYY-MM-DD HH24:MI:SS'),'Y','N',0,2)
;

-- Sep 2, 2013 3:33:13 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,Created,CreatedBy,Updated,IsActive,AD_Client_ID,ColumnSpan) VALUES ('N',200112,22,'N','N',210860,50,'Y',202485,'N','D','Dashboard Content','e37d0b4a-162e-4289-a5c2-ee8d9846e395','Y','N',100,0,TO_TIMESTAMP('2013-09-02 15:33:13','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2013-09-02 15:33:13','YYYY-MM-DD HH24:MI:SS'),'Y',0,2)
;

-- Sep 2, 2013 3:33:14 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,Created,CreatedBy,Updated,IsActive,AD_Client_ID,ColumnSpan) VALUES ('N',200112,22,'N','N',210861,60,'Y',202486,'N','The User identifies a unique user in the system. This could be an internal user or a business partner contact','D','User within the system - Internal or Business Partner Contact','User/Contact','8afd92c4-4999-4e3f-bf4f-59e50f55eb68','Y','N',100,0,TO_TIMESTAMP('2013-09-02 15:33:13','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2013-09-02 15:33:13','YYYY-MM-DD HH24:MI:SS'),'Y',0,2)
;

-- Sep 2, 2013 3:33:14 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,Created,CreatedBy,Updated,IsActive,AD_Client_ID,ColumnSpan) VALUES ('N',200112,22,'N','N',210862,70,'Y',202487,'N','The Role determines security and access a user who has this Role will have in the System.','D','Responsibility Role','Role','187ba2fa-56c2-449c-81d5-941145102c9e','Y','N',100,0,TO_TIMESTAMP('2013-09-02 15:33:14','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2013-09-02 15:33:14','YYYY-MM-DD HH24:MI:SS'),'Y',0,2)
;
...
There are two reasons for de-activating and not deleting records:
(1) The system requires the record for audit purposes.
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.','D','The record is active in the system','Active','e2859788-82c8-4c92-a4b3-ef0e75663f63','Y','N',100,0,TO_TIMESTAMP('2013-09-02 15:33:14','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2013-09-02 15:33:14','YYYY-MM-DD HH24:MI:SS'),'Y',2,0,2)
;

-- Sep 2, 2013 3:33:58 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Field SET SeqNo=30,Updated=TO_TIMESTAMP('2013-09-02 15:33:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202485
;

-- Sep 2, 2013 3:33:58 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Field SET SeqNo=40,Updated=TO_TIMESTAMP('2013-09-02 15:33:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202486
;

-- Sep 2, 2013 3:33:58 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Field SET SeqNo=50, IsDisplayed='Y', XPosition=4,Updated=TO_TIMESTAMP('2013-09-02 15:33:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202487
;

-- Sep 2, 2013 3:33:58 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Field SET SeqNo=60,Updated=TO_TIMESTAMP('2013-09-02 15:33:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202488
;

-- Sep 2, 2013 3:33:58 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Field SET SeqNo=0,Updated=TO_TIMESTAMP('2013-09-02 15:33:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202483
;

-- Sep 2, 2013 3:33:58 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Field SET SeqNo=0,Updated=TO_TIMESTAMP('2013-09-02 15:33:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202484
;

-- Sep 2, 2013 3:46:01 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Tab SET TabLevel=1,Updated=TO_TIMESTAMP('2013-09-02 15:46:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=200112
;

-- Sep 2, 2013 3:50:02 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Column SET DefaultValue='@#PA_DashboardContent_ID@',Updated=TO_TIMESTAMP('2013-09-02 15:50:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=210860
;

-- Sep 2, 2013 3:51:35 PM COT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Tab SET DisplayLogic='@#AD_Client_ID@ > 0',Updated=TO_TIMESTAMP('2013-09-02 15:51:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=200112
;

-- Sep 12, 2013 5:06:23 PM MYT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Window SET Name='Dashboard Content',Updated=TO_TIMESTAMP('2013-09-12 17:06:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Window_ID=50007
;

-- Sep 12, 2013 5:06:23 PM MYT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Menu SET Name='Dashboard Content', Description=NULL, IsActive='Y',Updated=TO_TIMESTAMP('2013-09-12 17:06:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=50010
;

-- Sep 12, 2013 5:06:47 PM MYT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Tab SET Name='Dashboard Content',Updated=TO_TIMESTAMP('2013-09-12 17:06:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=50010
;

-- Sep 12, 2013 5:11:21 PM MYT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Tab SET SeqNo=30,Updated=TO_TIMESTAMP('2013-09-12 17:11:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=53372
;

-- Sep 12, 2013 5:11:28 PM MYT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Tab SET SeqNo=20,Updated=TO_TIMESTAMP('2013-09-12 17:11:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=200112
;

-- Sep 12, 2013 5:13:11 PM MYT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Column SET IsParent='Y', IsUpdateable='N', DefaultValue=NULL,Updated=TO_TIMESTAMP('2013-09-12 17:13:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=210860
;

-- Sep 12, 2013 5:14:32 PM MYT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2013-09-12 17:14:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202481
;

-- Sep 12, 2013 5:19:27 PM MYT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Column SET DefaultValue='-1',Updated=TO_TIMESTAMP('2013-09-12 17:19:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=210861
;

-- Sep 12, 2013 5:20:24 PM MYT
-- IDEMPIERE-1064 Control dashboard access by role
UPDATE AD_Tab SET IsSingleRow='Y',Updated=TO_TIMESTAMP('2013-09-12 17:20:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=200112
;
