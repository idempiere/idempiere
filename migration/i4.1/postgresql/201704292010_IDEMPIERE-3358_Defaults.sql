...
INSERT INTO AD_SysConfig (AD_SysConfig_ID,AD_Client_ID,AD_Org_ID,Created,Updated,CreatedBy,UpdatedBy,IsActive,Name,Value,Description,EntityType,ConfigurationLevel,AD_SysConfig_UU) VALUES (200095,0,0,TO_TIMESTAMP('2017-04-29 20:07:14','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2017-04-29 20:07:14','YYYY-MM-DD HH24:MI:SS'),100,100,'Y','DEFAULT_ENTITYTYPE','U','Set the default for EntityType columns and parameters - useful when working on a plugin with a different EntityType than U','D','S','5dd403ad-a926-4e38-a058-b9b6b1ea052e')
;
...
UPDATE AD_Column SET DefaultValue='Y',Updated=TO_TIMESTAMP('2017-04-29 20:26:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=8564
;

-- Apr 29, 2017 8:27:05 PM CEST
UPDATE AD_Column SET DefaultValue='Y',Updated=TO_TIMESTAMP('2017-04-29 20:27:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=4426
;
...
UPDATE AD_Message SET MsgText='New',Updated=TO_TIMESTAMP('2017-04-29 21:14:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Message_ID=347
;
