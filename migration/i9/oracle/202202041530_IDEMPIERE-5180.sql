...
UPDATE AD_Process_Para SET DisplayLogic='@#AD_Client_ID@ = 0',Updated=TO_DATE('2022-02-07 06:40:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=538
;

-- Feb 7, 2022, 6:53:13 AM CET
UPDATE AD_Process_Para SET IsMandatory='N',Updated=TO_DATE('2022-02-07 06:53:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=538
;
...
UPDATE AD_Process_Para SET IsCentrallyMaintained='N', Placeholder='Leave the field empty to run it for all clients',Updated=TO_DATE('2022-02-08 08:26:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=538
;
