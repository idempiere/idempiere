...
DROP INDEX IF EXISTS ad_session_websession_servername_processed
;
...
DROP INDEX IF EXISTS ad_window_access_ad_role_id
;
...
INSERT INTO t_alter_column values('ad_tableindex','Name','VARCHAR(128)',null,null)
;
...
DROP INDEX IF EXISTS ad_private_access_ad_table_id_isactive_ad_user_id_record_id
;
...
DROP INDEX IF EXISTS ad_note_ad_client_id_processed_ad_user_id_ad_broadcastmessage
;
...
DROP INDEX IF EXISTS ad_sequence_name_ad_client_id
;
...
DROP INDEX IF EXISTS ad_user_name
;
