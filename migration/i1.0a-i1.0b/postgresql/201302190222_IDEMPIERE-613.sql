...
UPDATE AD_Process_Para SET DisplayLogic='@IsEncrypted@=Y',Updated=TO_TIMESTAMP('2013-02-14 12:24:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=647
;

-- Feb 14, 2013 12:25:07 PM MYT
-- IDEMPIERE-613 Column Encryption Enhancement
UPDATE AD_Process_Para SET DisplayLogic='@IsEncrypted@=Y',Updated=TO_TIMESTAMP('2013-02-14 12:25:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=648
;
