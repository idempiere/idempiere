...
-- Ticket 1001770: RMA improvements
ALTER TABLE M_RMA ADD COLUMN CreateFrom CHAR(1) DEFAULT NULL 
;

-- Jan 17, 2013 4:59:53 PM SGT
-- Ticket 1001770: RMA improvements
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',628,1,'N','N',208381,'Y',201654,'N','The Create From process will create a new document based on information in an existing document selected by the user.','D','Process which will generate a new document lines based on an existing document','Create lines from','N','Y','7670ee3c-1706-4878-959e-76e72553cb9f',100,0,TO_TIMESTAMP('2013-01-17 16:59:52','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-17 16:59:52','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket 1001770: RMA improvements
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',628,22,'N','N',57790,'Y',201656,'N','D','Referenced RMA','N','Y','98cee54f-a60a-4d4c-8882-4b83bc46216b',100,0,TO_TIMESTAMP('2013-01-17 16:59:54','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-17 16:59:54','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket 1001770: RMA improvements
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',53280,36,'N','N',60948,'Y',201658,'N','D','M_RMA_UU','N','Y','0b3c888d-b170-4abb-9517-c981b49daabe',100,0,TO_TIMESTAMP('2013-01-17 17:02:03','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-17 17:02:03','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket 1001770: RMA improvements
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',53280,22,'N','N',57790,'Y',201659,'N','D','Referenced RMA','N','Y','0e186562-ad5d-4e2e-b531-21d4c9505960',100,0,TO_TIMESTAMP('2013-01-17 17:02:04','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-17 17:02:04','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket 1001770: RMA improvements
UPDATE AD_Field SET XPosition=2, ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-17 17:02:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201657
;
