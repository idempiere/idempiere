...
-- IDEMPIERE-764 Some tablenames starts with X whereas they have centralized IDs
UPDATE AD_Val_Rule SET Code='M_ShippingProcessor.M_ShippingProcessorCfg_ID IN (SELECT M_ShippingProcessorCfg_ID FROM M_ShipperCfg WHERE M_ShipperCfg_ID=@M_ShipperCfg_ID@)',Updated=TO_DATE('2013-03-18 17:35:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=200018
;

-- Mar 18, 2013 5:36:43 PM COT
-- IDEMPIERE-764 Some tablenames starts with X whereas they have centralized IDs
UPDATE AD_Val_Rule SET Code='M_ShipperLabelsCfg.M_ShipperLabelsCfg_ID IN (SELECT M_ShipperLabelsCfg_ID FROM M_ShipperLabelsCfg WHERE M_ShipperCfg_ID IN (SELECT M_ShipperCfg_ID FROM M_Shipper WHERE M_Shipper_ID=@M_Shipper_ID@))', Name='M_ShipperLabels M_ShipperLabelsCfg_ID',Updated=TO_DATE('2013-03-18 17:36:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=200020
;

-- Mar 18, 2013 5:37:18 PM COT
-- IDEMPIERE-764 Some tablenames starts with X whereas they have centralized IDs
UPDATE AD_Val_Rule SET Code='M_ShipperPackagingCfg.M_ShipperPackagingCfg_ID IN (SELECT M_ShipperPackagingCfg_ID FROM M_ShipperPackagingCfg WHERE M_ShipperCfg_ID IN (SELECT M_ShipperCfg_ID FROM M_Shipper WHERE M_Shipper_ID=@M_Shipper_ID@))', Name='M_ShipperPackaging M_ShipperPackagingCfg_ID',Updated=TO_DATE('2013-03-18 17:37:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=200021
;

-- Mar 18, 2013 5:37:56 PM COT
-- IDEMPIERE-764 Some tablenames starts with X whereas they have centralized IDs
UPDATE AD_Val_Rule SET Code='M_ShipperPickupTypesCfg.M_ShipperPickupTypesCfg_ID IN (SELECT M_ShipperPickupTypesCfg_ID FROM M_ShipperPickupTypesCfg WHERE M_ShipperCfg_ID IN (SELECT M_ShipperCfg_ID FROM M_Shipper WHERE M_Shipper_ID=@M_Shipper_ID@))', Name='M_ShipperPickupTypes M_ShipperPickupTypesCfg_ID',Updated=TO_DATE('2013-03-18 17:37:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=200022
;
