...
UPDATE AD_Element SET ColumnName='CountryOfManufacture_ID',Updated=TO_DATE('2013-04-19 15:45:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=200319
;
...
-- IDEMPIERE-867 Wrong shipping columns naming
ALTER TABLE M_CommodityShipment ADD CountryOfManufacture_ID NUMBER(10) DEFAULT NULL 
;

UPDATE M_CommodityShipment SET CountryOfManufacture_ID = CAST(CountryOfManufacture AS NUMBER);

ALTER TABLE M_CommodityShipment DROP COLUMN CountryOfManufacture;

-- Apr 19, 2013 3:38:59 PM SGT
-- IDEMPIERE-867 Wrong shipping columns naming
UPDATE AD_Column SET IsMandatory='Y',Updated=TO_DATE('2013-04-19 15:38:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=201234
;

-- Apr 19, 2013 3:39:02 PM SGT
-- IDEMPIERE-867 Wrong shipping columns naming
ALTER TABLE M_CommodityShipment MODIFY CountryOfManufacture_ID NUMBER(10)
;

-- Apr 19, 2013 3:39:02 PM SGT
-- IDEMPIERE-867 Wrong shipping columns naming
ALTER TABLE M_CommodityShipment MODIFY CountryOfManufacture_ID NOT NULL
;

-- Apr 19, 2013 3:40:18 PM SGT
-- IDEMPIERE-867 Wrong shipping columns naming
UPDATE AD_Element SET ColumnName='HoldAddress_ID',Updated=TO_DATE('2013-04-19 15:40:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=200273
;
...
-- IDEMPIERE-867 Wrong shipping columns naming
ALTER TABLE M_Package ADD HoldAddress_ID NUMBER(10) DEFAULT NULL 
;

UPDATE M_Package SET HoldAddress_ID = CAST(HoldAddress AS NUMBER);

ALTER TABLE M_Package DROP COLUMN HoldAddress;

-- Apr 19, 2013 3:50:03 PM SGT
-- IDEMPIERE-867 Wrong shipping columns naming
ALTER TABLE M_ShippingTransaction ADD HoldAddress_ID NUMBER(10) DEFAULT NULL 
;

UPDATE M_ShippingTransaction SET HoldAddress_ID = CAST(HoldAddress AS NUMBER);
