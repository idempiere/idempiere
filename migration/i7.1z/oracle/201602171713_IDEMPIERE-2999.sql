...
INSERT INTO AD_Element (AD_Element_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,ColumnName,Name,PrintName,EntityType,AD_Element_UU) VALUES (202981,0,0,'Y',TO_DATE('2016-03-03 11:19:19','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2016-03-03 11:19:19','YYYY-MM-DD HH24:MI:SS'),100,'ValueInt','Value','Value','D','12e1f7c7-5b52-4190-8777-10da977b2b05')
;

-- Mar 3, 2016 11:20:16 AM IST
INSERT INTO AD_Column (AD_Column_ID,Version,Name,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure) VALUES (212645,0,'Value',561,'ValueInt',22,'N','N','N','N','N',0,'N',11,0,0,'Y',TO_DATE('2016-03-03 11:20:15','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2016-03-03 11:20:15','YYYY-MM-DD HH24:MI:SS'),100,202981,'Y','N','D','N','N','N','Y','893764b7-1e65-4fb2-81a5-9ac4acf1428d','Y',0,'N','N')
;

-- Mar 3, 2016 11:20:20 AM IST
ALTER TABLE M_AttributeInstance ADD ValueInt NUMBER(10) DEFAULT NULL 
;

-- Mar 3, 2016 11:20:32 AM IST
UPDATE AD_Column SET FieldLength=10,Updated=TO_DATE('2016-03-03 11:20:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=212645
;

-- Mar 3, 2016 11:20:35 AM IST
ALTER TABLE M_AttributeInstance MODIFY ValueInt NUMBER(10) DEFAULT NULL 
;

-- Mar 3, 2016 11:22:28 AM IST
INSERT INTO AD_Element (AD_Element_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,ColumnName,Name,Description,PrintName,EntityType,AD_Element_UU) VALUES (202982,0,0,'Y',TO_DATE('2016-03-03 11:22:24','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2016-03-03 11:22:24','YYYY-MM-DD HH24:MI:SS'),100,'ValueTimeStamp','Value','TimeStamp Value','Value','D','e0775628-b063-44d7-8586-a5f384301d22')
;

-- Mar 3, 2016 11:22:40 AM IST
UPDATE AD_Element SET Description='Integer Value',Updated=TO_DATE('2016-03-03 11:22:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=202981
;
