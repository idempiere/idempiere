...
UPDATE AD_Column SET FKConstraintName='ADRole_ADTreeFavorite', FKConstraintType='C',Updated=TO_DATE('2017-06-07 17:27:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=213059
;
...
-- Jun 7, 2017 5:27:57 PM IST
CREATE TABLE AD_Tree_Favorite (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, AD_Role_ID NUMBER(10) NOT NULL, AD_Tree_Favorite_ID NUMBER(10) NOT NULL, AD_Tree_Favorite_UU VARCHAR2(36) DEFAULT NULL , AD_User_ID NUMBER(10) NOT NULL, Created DATE DEFAULT SYSDATE, CreatedBy NUMBER(10) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Updated DATE DEFAULT SYSDATE, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT AD_Tree_Favorite_Key PRIMARY KEY (AD_Tree_Favorite_ID), CONSTRAINT AD_Tree_Favorite_UU_idx UNIQUE (AD_Tree_Favorite_UU))
;
...
INSERT INTO PA_DashboardContent (Name,AD_Org_ID,Created,CreatedBy,Description,UpdatedBy,IsActive,Line,Updated,AD_Client_ID,PA_DashboardContent_ID,ColumnNo,ZulFilePath,IsCollapsible,GoalDisplay,PA_DashboardContent_UU,IsShowInDashboard,IsEmbedReportContent,IsCollapsedByDefault,AD_User_ID,AD_Role_ID,IsShowinLogin) VALUES ('User Favorites Menu',0,TO_DATE('2017-06-07 17:48:00','YYYY-MM-DD HH24:MI:SS'),100,'User''s Favorites Menu Panel Display on Dashboard',100,'Y',0,TO_DATE('2017-06-07 17:48:00','YYYY-MM-DD HH24:MI:SS'),0,200004,1,'/zul/userfavorites.zul','Y','T','34c83380-2964-4358-8b00-e3cfb195e40c','Y','N','N',0,0,'Y')
;
...
-- Jun 12, 2017 6:38:26 PM IST
ALTER TABLE AD_Tree_Favorite_Node ADD Parent_ID NUMBER(10) DEFAULT NULL 
;
