...
-- Jun 7, 2017 5:27:57 PM IST
CREATE TABLE AD_Tree_Favorite (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, AD_Role_ID NUMBER(10) NOT NULL, AD_Tree_Favorite_ID NUMBER(10) NOT NULL, AD_Tree_Favorite_UU VARCHAR2(36 CHAR) DEFAULT NULL , AD_User_ID NUMBER(10) NOT NULL, Created DATE DEFAULT SYSDATE, CreatedBy NUMBER(10) DEFAULT NULL , IsActive VARCHAR2(1 CHAR) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Updated DATE DEFAULT SYSDATE, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT AD_Tree_Favorite_Key PRIMARY KEY (AD_Tree_Favorite_ID), CONSTRAINT AD_Tree_Favorite_UU_idx UNIQUE (AD_Tree_Favorite_UU))
;
