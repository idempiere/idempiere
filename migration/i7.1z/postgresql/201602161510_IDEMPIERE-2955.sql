...
UPDATE AD_Column SET AD_Reference_Value_ID=200115,Updated=TO_TIMESTAMP('2015-12-02 11:56:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=212554
;

-- Dec 2, 2015 11:56:42 AM IST
ALTER TABLE M_AttributeSet ADD COLUMN M_AttributeSet_Type VARCHAR(3) DEFAULT 'MMS' 
;

-- Dec 2, 2015 12:01:46 PM IST
INSERT INTO AD_Field (AD_Field_ID,Name,AD_Tab_ID,AD_Column_ID,IsDisplayed,DisplayLength,SeqNo,SortNo,IsSameLine,IsHeading,IsFieldOnly,IsEncrypted,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsReadOnly,IsCentrallyMaintained,EntityType,AD_Field_UU,IsDisplayedGrid,SeqNoGrid,XPosition,ColumnSpan,NumLines,IsQuickEntry,IsDefaultFocus,IsAdvancedField) VALUES (204081,'AttributeSet Type',461,212554,'Y',0,220,0,'N','N','N','N',0,0,'Y',TO_TIMESTAMP('2015-12-02 12:01:45','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2015-12-02 12:01:45','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','D','caa0a379-b7c5-4485-ba5b-5d4bff21d144','Y',210,1,1,1,'N','N','N')
;

-- Dec 2, 2015 12:03:35 PM IST
UPDATE AD_Field SET SeqNo=220, ColumnSpan=2,Updated=TO_TIMESTAMP('2015-12-02 12:03:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=204081
;

-- Mar 10, 2016 8:08:28 PM IST
INSERT INTO AD_Val_Rule (AD_Val_Rule_ID,Name,Description,Type,Code,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,EntityType,AD_Val_Rule_UU) VALUES (200093,'AttributeSetMMS','Get MMS type AttributeSet','S','M_AttributeSet_Type=''MMS''',0,0,'Y',TO_TIMESTAMP('2016-03-10 20:08:27','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2016-03-10 20:08:27','YYYY-MM-DD HH24:MI:SS'),100,'D','1dc169ec-e8ac-4d7a-91d4-fa7789170cf1')
;

-- Mar 10, 2016 8:35:47 PM IST
UPDATE AD_Column SET AD_Val_Rule_ID=200093,Updated=TO_TIMESTAMP('2016-03-10 20:35:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=8417
;

-- Sep 14, 2020, 6:30:08 PM IST
UPDATE AD_InfoColumn SET AD_Val_Rule_ID=200093, SeqNoSelection=10,Updated=TO_TIMESTAMP('2020-09-14 18:30:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=200007
;
