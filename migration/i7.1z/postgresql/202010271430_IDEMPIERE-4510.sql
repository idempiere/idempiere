...
UPDATE AD_Message SET MsgText='Select Query', Value='SelectQuery',Updated=TO_TIMESTAMP('2020-10-27 14:30:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Message_ID=53005
;
