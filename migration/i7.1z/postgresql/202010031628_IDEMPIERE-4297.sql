...
UPDATE AD_UserQuery SET IsDefault='Y',Updated=TO_TIMESTAMP('2020-10-03 17:02:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_UserQuery_ID=200000
;
...
-- Oct 3, 2020, 5:20:23 PM CEST
UPDATE AD_WF_EventAudit SET WFState='OR', EventType='SC', TextMsg=NULL,Updated=TO_TIMESTAMP('2020-10-03 17:20:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_EventAudit_ID=200012
;

-- Oct 3, 2020, 5:20:23 PM CEST
UPDATE AD_WF_Activity SET WFState='CC',Updated=TO_TIMESTAMP('2020-10-03 17:20:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Activity_ID=200012
;

-- Oct 3, 2020, 5:20:23 PM CEST
UPDATE AD_WF_EventAudit SET WFState='CC', EventType='PX', TextMsg=NULL, ElapsedTimeMS=1117,Updated=TO_TIMESTAMP('2020-10-03 17:20:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_EventAudit_ID=200012
;
...
-- Oct 3, 2020, 5:20:23 PM CEST
UPDATE AD_WF_Activity SET WFState='CC', TextMsg='8000: Grand Total=660.0 (#2)',Updated=TO_TIMESTAMP('2020-10-03 17:20:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Activity_ID=200013
;

-- Oct 3, 2020, 5:20:23 PM CEST
UPDATE AD_WF_EventAudit SET WFState='CC', EventType='PX', TextMsg='8000: Grand Total=660.0 (#2)', ElapsedTimeMS=880,Updated=TO_TIMESTAMP('2020-10-03 17:20:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_EventAudit_ID=200013
;
...
-- Oct 3, 2020, 5:20:24 PM CEST
UPDATE AD_WF_EventAudit SET WFState='OR', EventType='SC', TextMsg=NULL,Updated=TO_TIMESTAMP('2020-10-03 17:20:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_EventAudit_ID=200014
;
...
-- Oct 3, 2020, 5:20:24 PM CEST
UPDATE C_Order SET DocStatus='CO', DocAction='CL', IsApproved='Y', Processed='Y', ProcessedOn=1601738424536.5366,Updated=TO_TIMESTAMP('2020-10-03 17:20:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_Order_ID=200002
;
...
-- Oct 3, 2020, 5:20:24 PM CEST
UPDATE M_Product_PO SET PriceLastPO = (SELECT currencyConvert(ol.PriceActual,ol.C_Currency_ID,M_Product_PO.C_Currency_ID,o.DateOrdered,o.C_ConversionType_ID,o.AD_Client_ID,o.AD_Org_ID) FROM C_Order o, C_OrderLine ol WHERE o.C_Order_ID=ol.C_Order_ID AND M_Product_PO.M_Product_ID=ol.M_Product_ID AND M_Product_PO.C_BPartner_ID=o.C_BPartner_ID AND ol.C_OrderLine_ID = (SELECT MIN(ol1.C_OrderLine_ID) FROM C_Order o1, C_OrderLine ol1 WHERE o1.C_Order_ID=ol1.C_Order_ID AND M_Product_PO.M_Product_ID=ol1.M_Product_ID AND M_Product_PO.C_BPartner_ID=o1.C_BPartner_ID AND o1.C_Order_ID=200002) AND o.C_Order_ID=200002) WHERE EXISTS (SELECT * FROM C_Order o, C_OrderLine ol WHERE o.C_Order_ID=ol.C_Order_ID AND M_Product_PO.M_Product_ID=ol.M_Product_ID AND M_Product_PO.C_BPartner_ID=o.C_BPartner_ID AND o.C_Order_ID=200002)
;
...
-- Oct 3, 2020, 5:20:24 PM CEST
UPDATE AD_WF_Activity SET WFState='CC', TextMsg='8000: Grand Total=660.0',Updated=TO_TIMESTAMP('2020-10-03 17:20:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Activity_ID=200014
;

-- Oct 3, 2020, 5:20:24 PM CEST
UPDATE AD_WF_EventAudit SET WFState='CC', EventType='PX', TextMsg='8000: Grand Total=660.0', ElapsedTimeMS=601,Updated=TO_TIMESTAMP('2020-10-03 17:20:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_EventAudit_ID=200014
;

-- Oct 3, 2020, 5:20:24 PM CEST
UPDATE AD_WF_Activity SET Processed='Y',Updated=TO_TIMESTAMP('2020-10-03 17:20:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Activity_ID=200014
;

-- Oct 3, 2020, 5:20:24 PM CEST
UPDATE AD_WF_Process SET Processed='Y', WFState='CC',Updated=TO_TIMESTAMP('2020-10-03 17:20:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Process_ID=200004
;

-- Oct 3, 2020, 5:21:30 PM CEST
UPDATE C_OrderLine SET QtyReserved=0.0, LineNetAmt=360, Discount=40.00,Updated=TO_TIMESTAMP('2020-10-03 17:21:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_OrderLine_ID=200002
;
...
UPDATE C_OrderLine SET QtyReserved=0.0, LineNetAmt=300, Discount=40.00,Updated=TO_TIMESTAMP('2020-10-03 17:21:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_OrderLine_ID=200003
;
