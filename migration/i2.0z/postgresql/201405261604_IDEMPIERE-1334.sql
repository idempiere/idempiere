...
INSERT INTO AD_Reference (AD_Reference_ID,Name,EntityType,AD_Reference_UU,IsOrderByValue,Description,ValidationType,AD_Org_ID,CreatedBy,Updated,IsActive,Created,UpdatedBy,AD_Client_ID) VALUES (200083,'ad_info_process layout type','D','2171ebd2-e11a-4612-9885-128f155d65e8','N','define layout type of info process button','L',0,100,TO_TIMESTAMP('2014-05-26 22:31:42','YYYY-MM-DD HH24:MI:SS'),'Y',TO_TIMESTAMP('2014-05-26 22:31:42','YYYY-MM-DD HH24:MI:SS'),100,0)
;

-- May 26, 2014 10:31:43 PM ICT
INSERT INTO AD_Ref_List (AD_Ref_List_ID,AD_Reference_ID,Description,Name,AD_Ref_List_UU,Value,Created,CreatedBy,Updated,UpdatedBy,IsActive,EntityType,AD_Client_ID,AD_Org_ID) VALUES (200185,200083,'info process display as muilti buttons','Button','6884dcd1-bc9a-4d16-9b2c-fe40968747f8','Button',TO_TIMESTAMP('2014-05-26 22:31:42','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2014-05-26 22:31:42','YYYY-MM-DD HH24:MI:SS'),100,'Y','D',0,0)
;

-- May 26, 2014 10:31:44 PM ICT
INSERT INTO AD_Ref_List (AD_Ref_List_ID,AD_Reference_ID,Description,Name,AD_Ref_List_UU,Value,Created,CreatedBy,Updated,UpdatedBy,IsActive,EntityType,AD_Client_ID,AD_Org_ID) VALUES (200186,200083,'Each info process is a menu item, when click a button process, this menu is show','Menu','7b539591-296a-43ee-916c-c87c35acc84d','Menu',TO_TIMESTAMP('2014-05-26 22:31:43','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2014-05-26 22:31:43','YYYY-MM-DD HH24:MI:SS'),100,'Y','D',0,0)
;

-- May 26, 2014 10:31:44 PM ICT
INSERT INTO AD_Ref_List (AD_Ref_List_ID,AD_Reference_ID,Description,Name,AD_Ref_List_UU,Value,Created,CreatedBy,Updated,UpdatedBy,IsActive,EntityType,AD_Client_ID,AD_Org_ID) VALUES (200187,200083,'info process is display as drop down list','Drop List','ff0cba3e-e82c-4aa8-9f9b-bedf681b822d','Drop List',TO_TIMESTAMP('2014-05-26 22:31:44','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2014-05-26 22:31:44','YYYY-MM-DD HH24:MI:SS'),100,'Y','D',0,0)
;
...
-- May 26, 2014 10:31:45 PM ICT
ALTER TABLE AD_InfoProcess ADD COLUMN LayoutType VARCHAR(10) DEFAULT NULL 
;
...
(SELECT 
	(SELECT max (ad_infoprocess_id) + 1 FROM ad_infoprocess), ad_infowindow_id, iw.ad_client_id, iw.ad_org_id, 'Y', 100, 100, 10, pr.name, iw.ad_process_id, pr.description, pr.help, generate_uuid()
FROM 
	ad_infowindow iw INNER JOIN ad_process pr ON pr.ad_process_ID = iw.ad_process_ID	
WHERE 
	iw.ad_process_ID IS NOT NULL
);

UPDATE ad_sequence
	SET currentnext = (SELECT max (ad_infoprocess_id) + 1 FROM ad_infoprocess) 
WHERE 
	name = 'AD_InfoProcess' AND EXISTS (SELECT * FROM ad_infoprocess);
...
ALTER TABLE ad_infowindow DROP COLUMN ad_process_id;
