...
UPDATE AD_Column SET AD_Process_ID=NULL,Updated=TO_DATE('2014-10-30 18:57:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=61940
;

-- Oct 30, 2014 8:34:35 PM COT
UPDATE AD_Field SET EntityType='D',Updated=TO_DATE('2014-10-30 20:34:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202546
;
...
UPDATE AD_Column SET FKConstraintName='SalesRep_CContactActivity', FKConstraintType='N',Updated=TO_DATE('2014-10-30 20:54:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=62467
;
