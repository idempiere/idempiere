...
-- Mar 3, 2026, 2:25:26 PM BRT
ALTER TABLE C_BankTransfer ADD COLUMN From_DocType_ID NUMERIC(10) DEFAULT NULL 
;
...
-- Mar 3, 2026, 2:25:27 PM BRT
ALTER TABLE C_BankTransfer ADD COLUMN To_DocType_ID NUMERIC(10) DEFAULT NULL 
;
...
-- May 7, 2026, 1:03:00 PM CEST
UPDATE AD_Column SET AD_Reference_ID=18,Updated=TO_TIMESTAMP('2026-05-07 13:03:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=217387
;

-- May 7, 2026, 1:04:56 PM CEST
UPDATE AD_Column SET AD_Reference_ID=18,Updated=TO_TIMESTAMP('2026-05-07 13:04:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=217388
;