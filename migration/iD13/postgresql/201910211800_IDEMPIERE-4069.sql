...
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Reference_Value_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,FKConstraintType) VALUES (214095,0,'User Element List 1','User defined list element #1','The user defined element displays the optional elements that have been defined for this account combination.',450,'User1_ID',22,'N','N','N','N','N',0,'N',18,134,0,0,'Y',TO_TIMESTAMP('2019-10-21 12:34:43','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2019-10-21 12:34:43','YYYY-MM-DD HH24:MI:SS'),100,613,'Y','N','D','N','N','N','Y','8372271f-4c4a-48d1-b0e5-da4c3a97da64','Y',0,'N','N','N')
;

-- Oct 21, 2019 12:34:47 PM IST
UPDATE AD_Column SET FKConstraintName='User1_PAReportSource', FKConstraintType='N',Updated=TO_TIMESTAMP('2019-10-21 12:34:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=214095
;

-- Oct 21, 2019 12:34:47 PM IST
ALTER TABLE PA_ReportSource ADD COLUMN User1_ID NUMERIC(10) DEFAULT NULL 
;
...
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Reference_Value_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,FKConstraintType) VALUES (214096,0,'User Element List 2','User defined list element #2','The user defined element displays the optional elements that have been defined for this account combination.',450,'User2_ID',22,'N','N','N','N','N',0,'N',18,137,0,0,'Y',TO_TIMESTAMP('2019-10-21 12:35:03','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2019-10-21 12:35:03','YYYY-MM-DD HH24:MI:SS'),100,614,'Y','N','D','N','N','N','Y','aba09438-471b-4b31-9e43-485217418066','Y',0,'N','N','N')
;

-- Oct 21, 2019 12:35:06 PM IST
UPDATE AD_Column SET FKConstraintName='User2_PAReportSource', FKConstraintType='N',Updated=TO_TIMESTAMP('2019-10-21 12:35:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=214096
;

-- Oct 21, 2019 12:35:06 PM IST
ALTER TABLE PA_ReportSource ADD COLUMN User2_ID NUMERIC(10) DEFAULT NULL 
;
...
ALTER TABLE PA_ReportSource ADD COLUMN IsIncludeNullsUserList1 CHAR(1) DEFAULT 'N' CHECK (IsIncludeNullsUserList1 IN ('Y','N')) NOT NULL
;

-- Oct 21, 2019 1:31:36 PM IST
ALTER TABLE PA_ReportSource ADD COLUMN IsIncludeNullsUserList2 CHAR(1) DEFAULT 'N' CHECK (IsIncludeNullsUserList2 IN ('Y','N')) NOT NULL
;

-- Oct 21, 2019 1:32:19 PM IST
UPDATE AD_Field SET AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=5, ColumnSpan=2, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2019-10-21 13:32:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=206251
;

-- Oct 21, 2019 1:32:25 PM IST
UPDATE AD_Field SET AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=5, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2019-10-21 13:32:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=206249
;

-- Oct 21, 2019 1:33:05 PM IST
UPDATE AD_Field SET Name='User List 2', AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2019-10-21 13:33:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=206250
;

UPDATE AD_Column SET IsMandatory='N', IsUpdateable='N',Updated=TO_TIMESTAMP('2019-10-21 18:28:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=6084
;

-- Oct 21, 2019 6:28:26 PM IST
INSERT INTO t_alter_column values('pa_reportsource','PA_ReportLine_ID','NUMERIC(10)',null,'NULL')
;

-- Oct 21, 2019 6:28:26 PM IST
INSERT INTO t_alter_column values('pa_reportsource','PA_ReportLine_ID',null,'NULL',null)
;

-- Oct 21, 2019 4:58:27 PM IST
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,DefaultValue,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure) VALUES (214101,0,'Combination','Valid Account Combination','The Combination identifies a valid combination of element which represent a GL account.',544,'C_ValidCombination_ID','0',22,'N','N','N','N','N',0,'N',19,0,0,'Y',TO_TIMESTAMP('2019-10-21 16:58:26','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2019-10-21 16:58:26','YYYY-MM-DD HH24:MI:SS'),100,222,'Y','N','D','N','N','N','Y','87bc79a1-771a-4932-aca1-f5307be1c747','Y',0,'N','N')
;

-- Oct 21, 2019 7:43:11 PM IST
UPDATE AD_Column SET MandatoryLogic='@ElementType@=CO',Updated=TO_TIMESTAMP('2019-10-21 19:43:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=6087
;

-- Oct 21, 2019 4:58:37 PM IST
UPDATE AD_Column SET FKConstraintName='CValidCombination_TReport', FKConstraintType='N',Updated=TO_TIMESTAMP('2019-10-21 16:58:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=214101
;

-- Oct 21, 2019 4:58:37 PM IST
ALTER TABLE T_Report ADD COLUMN C_ValidCombination_ID NUMERIC(10) DEFAULT '0' 
;
...
UPDATE AD_Process_Para SET DefaultValue='Y',IsCentrallyMaintained='N',Updated=TO_TIMESTAMP('2019-10-25 11:48:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=547
;

-- Oct 25, 2019 11:48:29 AM IST
UPDATE AD_Column SET DefaultValue='N',Updated=TO_TIMESTAMP('2019-10-25 11:48:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=8176
;

-- Oct 25, 2019 1:23:22 PM IST
UPDATE AD_Ref_Table SET OrderByClause='C_Period.StartDate DESC',Updated=TO_TIMESTAMP('2019-10-25 13:23:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=275
;
