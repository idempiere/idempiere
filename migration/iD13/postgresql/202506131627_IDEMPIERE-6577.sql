...
-- Jun 13, 2025, 4:28:25 PM IST
ALTER TABLE I_Payment ADD COLUMN Description VARCHAR(255) DEFAULT NULL 
;
...
-- Jun 13, 2025, 4:28:25 PM IST
ALTER TABLE I_Payment ADD COLUMN C_Activity_ID NUMERIC(10) DEFAULT NULL 
;
...
-- Jun 13, 2025, 4:28:28 PM IST
ALTER TABLE I_Payment ADD COLUMN ActivityValue VARCHAR(40) DEFAULT NULL 
;
...
-- Jun 13, 2025, 4:28:40 PM IST
ALTER TABLE I_Invoice ADD COLUMN ISO_Code VARCHAR(3) DEFAULT NULL 
;
