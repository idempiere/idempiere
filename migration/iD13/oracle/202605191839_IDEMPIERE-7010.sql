...
ALTER TABLE M_InventoryLine MODIFY C_UOM_ID NUMBER(10)
;

-- May 19, 2026, 6:40:33 PM CEST
ALTER TABLE M_InventoryLine MODIFY C_UOM_ID NOT NULL
;
...
ALTER TABLE M_InventoryLine ADD QtyEntered NUMBER DEFAULT 0 NOT NULL
;
