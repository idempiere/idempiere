...
UPDATE AD_Ref_Table SET WhereClause=NULL, DisplaySQL='COALESCE(AD_Column.ColumnName,''-1'') || ''_'' || COALESCE(AD_Column.Name,''-1'')',Updated=TO_DATE('2024-02-23 12:17:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=200266
;
