...
-- Mar 6, 2026, 5:05:13 PM CET
CREATE TABLE AD_UserDef_Form (AD_Client_ID NUMBER(10) NOT NULL, AD_Form_ID NUMBER(10) NOT NULL, AD_Language VARCHAR2(6 CHAR) DEFAULT NULL , AD_Org_ID NUMBER(10) NOT NULL, AD_Role_ID NUMBER(10) DEFAULT NULL , AD_User_ID NUMBER(10) NOT NULL, AD_UserDef_Form_ID NUMBER(10) NOT NULL, AD_UserDef_Form_UU VARCHAR2/*UUID*/(36) DEFAULT NULL , Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, Description VARCHAR2(255 CHAR) DEFAULT NULL , Help VARCHAR2(2000 CHAR) DEFAULT NULL , ImageURL VARCHAR2(120 CHAR) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Name VARCHAR2(60 CHAR) NOT NULL, Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT AD_UserDef_Form_Key PRIMARY KEY (AD_UserDef_Form_ID), CONSTRAINT AD_UserDef_Form_UU_idx UNIQUE (AD_UserDef_Form_UU))
;
...
-- Mar 6, 2026, 5:07:54 PM CET
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 10, getDate(), 10,t.AD_Tree_ID, 200248, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=200248)
;
...
ALTER TABLE AD_UserDef_Form MODIFY Name VARCHAR2(60 CHAR) DEFAULT NULL 
;

-- Mar 6, 2026, 5:19:14 PM CET
ALTER TABLE AD_UserDef_Form MODIFY Name NULL
;

-- Mar 6, 2026, 5:19:14 PM CET
ALTER TABLE AD_UserDef_Form MODIFY AD_User_ID NUMBER(10) DEFAULT NULL 
;

-- Mar 6, 2026, 5:19:14 PM CET
ALTER TABLE AD_UserDef_Form MODIFY AD_User_ID NULL
;
