...
CREATE TABLE AD_AttachmentFile (AD_AttachmentFile_UU VARCHAR2/*UUID*/(36) DEFAULT NULL , AD_Attachment_ID NUMBER(10) DEFAULT NULL , AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, FileName VARCHAR2(1000 CHAR) DEFAULT NULL , FileSize NUMBER(10) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, SHA256Checksum VARCHAR2(64 CHAR) DEFAULT NULL , MIMEType VARCHAR2(1000 CHAR) DEFAULT NULL , SeqNo NUMBER(10) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT AD_AttachmentFile_UU_idx PRIMARY KEY (AD_AttachmentFile_UU))
;
...
ALTER TABLE AD_AttachmentFile ADD FilePath VARCHAR2(4000 CHAR) DEFAULT NULL 
;
...
ALTER TABLE AD_AttachmentFile MODIFY FileSize NUMBER DEFAULT NULL 
;
