...
ALTER TABLE C_AcctSchema ADD StartDate DATE DEFAULT NULL 
;
...
ALTER TABLE C_AcctSchema ADD EndDate DATE DEFAULT NULL 
;
...
ALTER TABLE C_DocType ADD IsAlwaysPosted CHAR(1) DEFAULT 'N' CHECK (IsAlwaysPosted IN ('Y','N')) NOT NULL
;
