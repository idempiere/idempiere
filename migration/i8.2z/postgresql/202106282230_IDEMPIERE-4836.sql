...
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.',200278,'IsActive','Y',1,'N','N','Y','N','N','N',20,0,0,'Y',TO_TIMESTAMP('2021-06-28 22:04:00','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2021-06-28 22:04:00','YYYY-MM-DD HH24:MI:SS'),100,348,'Y','N','D','Y','N','N','Y','66d964d7-ca07-42f1-8378-38c16ba15613','N','N','N','N','N')
;

-- Jun 28, 2021, 10:04:01 PM IST
ALTER TABLE PA_DocumentStatusAccess ADD COLUMN IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL
;
...
-- Jun 28, 2021, 10:04:02 PM IST
ALTER TABLE PA_DocumentStatusAccess ADD COLUMN Updated TIMESTAMP DEFAULT statement_timestamp() NOT NULL
;

-- Jun 28, 2021, 10:04:02 PM IST
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,IsEncrypted,AD_Reference_ID,AD_Reference_Value_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,IsToolbarButton,IsSecure,FKConstraintType,IsHtml) VALUES (214528,0.0,'Updated By','User who updated this records','The Updated By field indicates the user who updated this record.',200278,'UpdatedBy',22,'N','N','Y','N','N','N',30,110,0,0,'Y',TO_TIMESTAMP('2021-06-28 22:04:02','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2021-06-28 22:04:02','YYYY-MM-DD HH24:MI:SS'),100,608,'N','N','D','Y','N','N','Y','71859f0d-7527-490e-801b-c4842cf87691','N','N','N','D','N')
;

-- Jun 28, 2021, 10:04:02 PM IST
ALTER TABLE PA_DocumentStatusAccess ADD COLUMN UpdatedBy NUMERIC(10) NOT NULL
;

-- Jun 28, 2021, 10:04:03 PM IST
INSERT INTO AD_Element (AD_Element_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,ColumnName,Name,PrintName,EntityType,AD_Element_UU) VALUES (203520,0,0,'Y',TO_TIMESTAMP('2021-06-28 22:04:03','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2021-06-28 22:04:03','YYYY-MM-DD HH24:MI:SS'),100,'PA_DocumentStatusAccess_UU','PA_DocumentStatusAccess_UU','PA_DocumentStatusAccess_UU','D','29a600bf-6a44-49b6-ab05-a8d3b953b686')
;
...
-- Jun 28, 2021, 10:04:04 PM IST
ALTER TABLE PA_DocumentStatusAccess ADD COLUMN PA_DocumentStatusAccess_UU VARCHAR(36) DEFAULT NULL 
;
...
-- Jun 28, 2021, 10:04:05 PM IST
ALTER TABLE PA_DocumentStatusAccess ADD COLUMN AD_Role_ID NUMERIC(10) DEFAULT NULL 
;

-- Jun 28, 2021, 10:04:05 PM IST
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,FKConstraintName,FKConstraintType,IsHtml) VALUES (214531,0,'User/Contact','User within the system - Internal or Business Partner Contact','The User identifies a unique user in the system. This could be an internal user or a business partner contact',200278,'AD_User_ID',10,'N','N','N','N','N',0,'N',30,0,0,'Y',TO_TIMESTAMP('2021-06-28 22:04:05','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2021-06-28 22:04:05','YYYY-MM-DD HH24:MI:SS'),100,138,'Y','N','D','Y','N','N','Y','4cf1e3b0-8a54-4d92-82d8-1459b163862e','Y',0,'N','N','ADUser_PADocumentStatusAccess','N','N')
;

-- Jun 28, 2021, 10:04:05 PM IST
ALTER TABLE PA_DocumentStatusAccess ADD COLUMN AD_User_ID NUMERIC(10) DEFAULT NULL 
;

-- Jun 28, 2021, 10:04:06 PM IST
INSERT INTO AD_Column (AD_Column_ID,Version,Name,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,FKConstraintName,FKConstraintType,IsHtml) VALUES (214532,0,'Document Status',200278,'PA_DocumentStatus_ID',10,'N','N','N','N','N',0,'N',19,0,0,'Y',TO_TIMESTAMP('2021-06-28 22:04:05','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2021-06-28 22:04:05','YYYY-MM-DD HH24:MI:SS'),100,203069,'N','N','D','Y','N','N','Y','86869fbf-ad42-408c-991a-ccb1db786a40','Y',0,'N','N','PADocumentStatus_PADocStatAccs','N','N')
;

-- Jun 28, 2021, 10:04:06 PM IST
ALTER TABLE PA_DocumentStatusAccess ADD COLUMN PA_DocumentStatus_ID NUMERIC(10) DEFAULT NULL 
;

-- Jun 28, 2021, 10:04:06 PM IST
INSERT INTO AD_TableIndex (AD_Client_ID,AD_Org_ID,AD_TableIndex_ID,AD_TableIndex_UU,Created,CreatedBy,Description,EntityType,IsActive,Name,Updated,UpdatedBy,AD_Table_ID,IsCreateConstraint,IsUnique,Processing,TableIndexDrop,IsKey) VALUES (0,0,201088,'6ca2a538-7e1f-4ad9-ac6b-12bcbedc82f9',TO_TIMESTAMP('2021-06-28 22:04:06','YYYY-MM-DD HH24:MI:SS'),100,'Unique constraint on document status, User id and Role id','D','Y','DocStats_Role_User_Uniq_Idx',TO_TIMESTAMP('2021-06-28 22:04:06','YYYY-MM-DD HH24:MI:SS'),100,200278,'N','Y','N','N','N')
;

-- Jun 28, 2021, 10:04:06 PM IST
INSERT INTO AD_IndexColumn (AD_Client_ID,AD_Org_ID,AD_IndexColumn_ID,AD_IndexColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_Column_ID,AD_TableIndex_ID,SeqNo) VALUES (0,0,201425,'9636df4f-654c-4172-a4ce-f3624d7b1a92',TO_TIMESTAMP('2021-06-28 22:04:06','YYYY-MM-DD HH24:MI:SS'),100,'D','Y',TO_TIMESTAMP('2021-06-28 22:04:06','YYYY-MM-DD HH24:MI:SS'),100,214532,201088,0)
;

-- Jun 28, 2021, 10:04:06 PM IST
INSERT INTO AD_IndexColumn (AD_Client_ID,AD_Org_ID,AD_IndexColumn_ID,AD_IndexColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_TableIndex_ID,ColumnSQL,SeqNo) VALUES (0,0,201426,'85280741-04c9-4b91-8ba9-fae0aacb240c',TO_TIMESTAMP('2021-06-28 22:04:06','YYYY-MM-DD HH24:MI:SS'),100,'D','Y',TO_TIMESTAMP('2021-06-28 22:04:06','YYYY-MM-DD HH24:MI:SS'),100,201088,'COALESCE(AD_Role_ID,0)',0)
;

-- Jun 28, 2021, 10:04:06 PM IST
INSERT INTO AD_IndexColumn (AD_Client_ID,AD_Org_ID,AD_IndexColumn_ID,AD_IndexColumn_UU,Created,CreatedBy,EntityType,IsActive,Updated,UpdatedBy,AD_TableIndex_ID,ColumnSQL,SeqNo) VALUES (0,0,201427,'538c291c-b909-45fd-9224-e2c83db32681',TO_TIMESTAMP('2021-06-28 22:04:06','YYYY-MM-DD HH24:MI:SS'),100,'D','Y',TO_TIMESTAMP('2021-06-28 22:04:06','YYYY-MM-DD HH24:MI:SS'),100,201088,'COALESCE(Ad_User_ID,0)',0)
;
...
-- Jun 28, 2021, 10:04:07 PM IST
UPDATE AD_Tab SET SeqNo=30, AD_Column_ID=NULL, AD_Process_ID=NULL, AD_Image_ID=NULL, AD_ColumnSortYesNo_ID=NULL, AD_ColumnSortOrder_ID=NULL, Included_Tab_ID=NULL, Parent_Column_ID=NULL, AD_CtxHelp_ID=NULL,Updated=TO_TIMESTAMP('2021-06-28 22:04:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=200223
;
...
There are two reasons for de-activating and not deleting records:
(1) The system requires the record for audit purposes.
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.',200295,214526,'Y',1,60,'N','N','N','N',0,0,'Y',TO_TIMESTAMP('2021-06-28 22:04:12','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2021-06-28 22:04:12','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','D','e127991c-0e31-4def-95f2-4cb82ea4d552','Y',60,2,2,1,'N','N','N','N')
;
...
There are two reasons for de-activating and not deleting records:
(1) The system requires the record for audit purposes.
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.',200296,214526,'Y',1,60,'N','N','N','N',0,0,'Y',TO_TIMESTAMP('2021-06-28 22:04:19','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2021-06-28 22:04:19','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','D','b0c78b0c-2732-4490-bd2d-12ac8c8cef90','Y',60,2,2,1,'N','N','N','N')
;

-- Jun 28, 2021, 10:04:20 PM IST
INSERT INTO AD_Tab (AD_Tab_ID,Name,AD_Window_ID,SeqNo,IsSingleRow,AD_Table_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,HasTree,IsInfoTab,IsTranslationTab,IsReadOnly,AD_Column_ID,Processing,ImportFields,TabLevel,IsSortTab,EntityType,IsInsertRecord,IsAdvancedTab,AD_Tab_UU,TreeDisplayedOn,IsLookupOnlySelection,IsAllowAdvancedLookup,MaxQueryRecords) VALUES (200297,'Document Status Access',108,100,'Y',200278,0,0,'Y',TO_TIMESTAMP('2021-06-28 22:04:19','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2021-06-28 22:04:19','YYYY-MM-DD HH24:MI:SS'),100,'N','N','N','N',214531,'N','N',1,'N','D','Y','N','5dc2b3d5-02ef-4231-a9f3-3ebdfa35c445','B','N','Y',0)
;
...
UPDATE AD_Field SET IsDisplayed='N', AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsDisplayedGrid='N', IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2021-11-23 20:28:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=204404
;

-- Nov 23, 2021, 8:28:33 PM IST
UPDATE AD_Field SET IsDisplayed='N', AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsDisplayedGrid='N', IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2021-11-23 20:28:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=204405
;
