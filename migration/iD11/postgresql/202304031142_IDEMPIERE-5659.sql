...
-- Apr 3, 2023, 11:49:52 AM CEST
CREATE TABLE C_PeriodDocGroup (AD_Client_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, C_PeriodDocGroup_ID NUMERIC(10) NOT NULL, C_PeriodDocGroup_UU VARCHAR(36) DEFAULT NULL , Created TIMESTAMP NOT NULL, CreatedBy NUMERIC(10) NOT NULL, Help VARCHAR(2000) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Name VARCHAR(60) NOT NULL, Updated TIMESTAMP NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, Value VARCHAR(40) DEFAULT NULL , CONSTRAINT C_PeriodDocGroup_Key PRIMARY KEY (C_PeriodDocGroup_ID), CONSTRAINT C_PeriodDocGroup_UU_idx UNIQUE (C_PeriodDocGroup_UU))
;
...
-- Apr 3, 2023, 11:50:01 AM CEST
CREATE TABLE C_PeriodDocGroupLine (AD_Client_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, C_PeriodDocGroupLine_ID NUMERIC(10) NOT NULL, C_PeriodDocGroupLine_UU VARCHAR(36) DEFAULT NULL , C_PeriodDocGroup_ID NUMERIC(10) NOT NULL, Created TIMESTAMP NOT NULL, CreatedBy NUMERIC(10) NOT NULL, DocBaseType VARCHAR(3) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Updated TIMESTAMP NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, CONSTRAINT C_PeriodDocGroupLine_Key PRIMARY KEY (C_PeriodDocGroupLine_ID), CONSTRAINT C_PeriodDocGroupLine_UU_idx UNIQUE (C_PeriodDocGroupLine_UU))
;
