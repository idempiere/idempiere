...
-- Apr 3, 2023, 11:44:23 AM CEST
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 100, statement_timestamp(), 100,t.AD_Tree_ID, 200226, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=200226)
;
...
-- Apr 3, 2023, 11:49:52 AM CEST
CREATE TABLE C_DocBaseGroup (AD_Client_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, C_DocBaseGroup_ID NUMERIC(10) NOT NULL, C_DocBaseGroup_UU VARCHAR(36) DEFAULT NULL , Created TIMESTAMP NOT NULL, CreatedBy NUMERIC(10) NOT NULL, Help VARCHAR(2000) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Name VARCHAR(60) NOT NULL, Updated TIMESTAMP NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, Value VARCHAR(40) DEFAULT NULL , CONSTRAINT C_DocBaseGroup_Key PRIMARY KEY (C_DocBaseGroup_ID), CONSTRAINT C_DocBaseGroup_UU_idx UNIQUE (C_DocBaseGroup_UU))
;
...
-- Apr 3, 2023, 11:50:01 AM CEST
CREATE TABLE C_DocBaseGroupLine (AD_Client_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, C_DocBaseGroupLine_ID NUMERIC(10) NOT NULL, C_DocBaseGroupLine_UU VARCHAR(36) DEFAULT NULL , C_DocBaseGroup_ID NUMERIC(10) NOT NULL, Created TIMESTAMP NOT NULL, CreatedBy NUMERIC(10) NOT NULL, DocBaseType VARCHAR(3) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Updated TIMESTAMP NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, CONSTRAINT C_DocBaseGroupLine_Key PRIMARY KEY (C_DocBaseGroupLine_ID), CONSTRAINT C_DocBaseGroupLine_UU_idx UNIQUE (C_DocBaseGroupLine_UU))
;
