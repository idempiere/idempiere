...
ALTER TABLE PA_DocumentStatus ADD COLUMN JoinClause VARCHAR(2000) DEFAULT NULL 
;
...
ALTER TABLE PA_DocumentStatus ADD COLUMN CountClause VARCHAR(255) DEFAULT NULL 
;
