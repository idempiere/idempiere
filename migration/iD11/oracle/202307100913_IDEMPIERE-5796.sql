...
-- Jul 10, 2023, 9:18:31 AM CEST
CREATE TABLE AD_ModelGeneratorTemplate (AD_Client_ID NUMBER(10) NOT NULL, AD_ModelGeneratorTemplate_ID NUMBER(10) NOT NULL, AD_ModelGeneratorTemplate_UU VARCHAR2(36 CHAR) DEFAULT NULL , AD_Org_ID NUMBER(10) NOT NULL, ColumnEntityType VARCHAR2(20 CHAR) DEFAULT NULL , Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, Folder VARCHAR2(255 CHAR) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Name VARCHAR2(60 CHAR) NOT NULL, PackageName VARCHAR2(60 CHAR) DEFAULT NULL , TableEntityType VARCHAR2(20 CHAR) DEFAULT NULL , TableName VARCHAR2(60 CHAR) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT AD_ModelGeneratorTemplate_Key PRIMARY KEY (AD_ModelGeneratorTemplate_ID), CONSTRAINT AD_ModelGeneratorTemplateuuidx UNIQUE (AD_ModelGeneratorTemplate_UU))
;
...
-- Jul 10, 2023, 9:18:49 AM CEST
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 10, getDate(), 10,t.AD_Tree_ID, 200227, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=200227)
;
...
-- Jul 10, 2023, 9:24:07 AM CEST
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 10, getDate(), 10,t.AD_Tree_ID, 200228, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=200228)
;
...
ALTER TABLE AD_ModelGeneratorTemplate MODIFY TableName VARCHAR2(2000 CHAR) DEFAULT NULL 
;
