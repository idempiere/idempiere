...
-- May 28, 2026, 10:19:31 AM CEST
CREATE TABLE C_SalesPipeline (AD_Client_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, C_SalesPipeline_ID NUMERIC(10) NOT NULL, C_SalesPipeline_UU UUID DEFAULT NULL , Created TIMESTAMP NOT NULL, CreatedBy NUMERIC(10) NOT NULL, Description VARCHAR(255) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Name VARCHAR(60) NOT NULL, Updated TIMESTAMP NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, Value VARCHAR(40) DEFAULT NULL , CONSTRAINT C_SalesPipeline_Key PRIMARY KEY (C_SalesPipeline_ID), CONSTRAINT C_SalesPipeline_UU_idx UNIQUE (C_SalesPipeline_UU))
;
...
-- May 28, 2026, 10:19:37 AM CEST
CREATE TABLE C_SalesPipeline_Trl (AD_Client_ID NUMERIC(10) NOT NULL, AD_Language VARCHAR(6) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, C_SalesPipeline_ID NUMERIC(10) NOT NULL, C_SalesPipeline_Trl_UU UUID DEFAULT NULL , Created TIMESTAMP NOT NULL, CreatedBy NUMERIC(10) NOT NULL, Description VARCHAR(255) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, IsTranslated CHAR(1) DEFAULT 'N' CHECK (IsTranslated IN ('Y','N')) NOT NULL, Name VARCHAR(60) NOT NULL, Updated TIMESTAMP NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, CONSTRAINT C_SalesPipeline_Trl_UU_idx UNIQUE (C_SalesPipeline_Trl_UU))
;
...
-- May 28, 2026, 10:45:15 AM CEST
ALTER TABLE C_Opportunity ADD COLUMN C_SalesPipeline_ID NUMERIC(10) DEFAULT NULL 
;
