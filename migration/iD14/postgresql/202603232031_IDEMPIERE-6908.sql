...
CREATE TABLE AD_Extension (AD_Client_ID NUMERIC(10) NOT NULL, AD_Extension_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, Created TIMESTAMP DEFAULT statement_timestamp() NOT NULL, CreatedBy NUMERIC(10) NOT NULL, ExtensionId VARCHAR(255) NOT NULL, ExtensionMetadata JSONB NOT NULL, ExtensionState VARCHAR(2) NOT NULL, ExtensionVersion VARCHAR(30) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, IsBundled CHAR(1) DEFAULT 'N' CHECK (IsBundled IN ('Y','N')) NOT NULL, Updated TIMESTAMP DEFAULT statement_timestamp() NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, CONSTRAINT AD_Extension_Key PRIMARY KEY (AD_Extension_ID))
;
...
ALTER TABLE AD_Extension ADD COLUMN AD_Extension_UU UUID NOT NULL
;
...
-- Mar 23, 2026, 11:57:17 PM GMT+08:00
CREATE TABLE AD_ExtensionEntity (AD_Client_ID NUMERIC(10) NOT NULL, AD_ExtensionEntity_ID NUMERIC(10) NOT NULL, AD_ExtensionEntity_UU UUID NOT NULL, AD_Extension_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, AD_Table_ID NUMERIC(10) NOT NULL, Created TIMESTAMP DEFAULT statement_timestamp() NOT NULL, CreatedBy NUMERIC(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Record_UU UUID NOT NULL, Updated TIMESTAMP DEFAULT statement_timestamp() NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, CONSTRAINT AD_ExtensionEntity_Key PRIMARY KEY (AD_ExtensionEntity_ID), CONSTRAINT AD_ExtensionEntity_UU_idx UNIQUE (AD_ExtensionEntity_UU))
;
