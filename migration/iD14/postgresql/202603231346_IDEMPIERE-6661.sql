...
ALTER TABLE AD_Scheduler ADD COLUMN WebSessionLogic VARCHAR(60) DEFAULT NULL 
;
...
INSERT INTO t_alter_column values('ad_session','WebSession','VARCHAR(255)',null,'NULL')
;
