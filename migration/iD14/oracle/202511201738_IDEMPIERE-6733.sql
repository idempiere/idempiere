...
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Reference_Value_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,IsHtml,IsPartitionKey,FKConstraintType) VALUES (217168,0,'Business Partner','Identifies a Business Partner','A Business Partner is anyone with whom you transact.  This can include Vendor, Customer, Employee or Salesperson',545,'C_BPartner_ID',22,'N','N','N','N','N',0,'N',30,200175,0,0,'Y',TO_TIMESTAMP('2025-11-20 17:39:42','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2025-11-20 17:39:42','YYYY-MM-DD HH24:MI:SS'),100,187,'N','N','D','N','N','N','Y','019aa12b-a488-76e7-bee0-2b2e86d33cb6','Y',0,'N','N','N','N','D')
;
...
BEGIN EXECUTE IMMEDIATE 'ALTER TABLE T_ReportStatement DROP CONSTRAINT t_reportstatement_key'; EXCEPTION WHEN OTHERS THEN IF SQLCODE = -1418 THEN NULL; ELSE RAISE; END IF; END;
/

BEGIN EXECUTE IMMEDIATE 'DROP INDEX t_reportstatement_key'; EXCEPTION WHEN OTHERS THEN IF SQLCODE = -1418 THEN NULL; ELSE RAISE; END IF; END;
/
