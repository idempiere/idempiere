...
CREATE TABLE C_DocRoundingRule (AD_Client_ID NUMBER(10) NOT NULL)
;
...
ALTER TABLE C_DocRoundingRule ADD AD_Org_ID NUMBER(10) NOT NULL
;
...
-- Jun 21, 2022, 2:23:42 PM CEST
ALTER TABLE C_DocRoundingRule ADD C_Currency_ID NUMBER(10) NOT NULL
;
...
ALTER TABLE C_DocRoundingRule ADD C_DocRoundingRule_ID NUMBER(10) NOT NULL
;
...
ALTER TABLE C_DocRoundingRule ADD C_DocRoundingRule_UU VARCHAR2(36 CHAR) DEFAULT NULL 
;
...
-- Jun 21, 2022, 2:39:22 PM CEST
ALTER TABLE C_DocRoundingRule ADD C_DocType_ID NUMBER(10) NOT NULL
;
...
ALTER TABLE C_DocRoundingRule MODIFY C_DocType_ID NUMBER(10)
;
...
ALTER TABLE C_DocRoundingRule ADD Created DATE DEFAULT SYSDATE NOT NULL
;
...
ALTER TABLE C_DocRoundingRule ADD CreatedBy NUMBER(10) NOT NULL
;

-- Jun 21, 2022, 2:41:16 PM CEST
ALTER TABLE C_DocRoundingRule ADD Description VARCHAR2(255 CHAR) DEFAULT NULL 
;
...
ALTER TABLE C_DocRoundingRule ADD IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL
;
...
ALTER TABLE C_DocRoundingRule ADD Name VARCHAR2(60 CHAR) NOT NULL
;
...
ALTER TABLE C_DocRoundingRule ADD RoundingRule VARCHAR2(22 CHAR) NOT NULL
;
...
ALTER TABLE C_DocRoundingRule ADD Updated DATE DEFAULT SYSDATE NOT NULL
;
...
ALTER TABLE C_DocRoundingRule ADD UpdatedBy NUMBER(10) NOT NULL
;
...
ALTER TABLE C_DocRoundingRule ADD PaymentRule CHAR(1) DEFAULT NULL  CHECK (PaymentRule IN ('Y','N'))
;
...
-- Jun 21, 2022, 2:52:13 PM CEST
ALTER TABLE C_DocRoundingRule ADD C_Charge_ID NUMBER(10) NOT NULL
;
...
-- Jun 23, 2022, 9:20:00 AM CEST
ALTER TABLE C_DocRoundingRule MODIFY RoundingRule VARCHAR2(22 CHAR)
;

-- Jun 23, 2022, 9:20:00 AM CEST
ALTER TABLE C_DocRoundingRule MODIFY PaymentRule CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE C_Order ADD CurrencyRoundAmt NUMBER(10)
;
...
ALTER TABLE C_Invoice ADD CurrencyRoundAmt NUMBER(10)
;
...
-- Jun 23, 2022, 5:00:13 PM CEST
ALTER TABLE C_AcctSchema_Default ADD RoundingGain_Acct NUMBER(10) DEFAULT NULL 
;
...
-- Jun 23, 2022, 5:00:48 PM CEST
ALTER TABLE C_AcctSchema_Default ADD RoundingLoss_Acct NUMBER(10) DEFAULT NULL 
;
...
-- Jun 27, 2022, 1:55:59 PM CEST
ALTER TABLE C_Order MODIFY CurrencyRoundAmt NUMBER DEFAULT 0
;
...
-- Jun 27, 2022, 1:56:47 PM CEST
ALTER TABLE C_Invoice MODIFY CurrencyRoundAmt NUMBER DEFAULT 0
;
