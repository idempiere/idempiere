...
-- Apr 15, 2022, 1:50:42 PM CEST
CREATE TABLE C_LabelCategory (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, C_LabelCategory_ID NUMBER(10) NOT NULL, C_LabelCategory_UU VARCHAR2(36 CHAR) DEFAULT NULL , Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, IsDefault CHAR(1) DEFAULT 'N' CHECK (IsDefault IN ('Y','N')) NOT NULL, Name VARCHAR2(60 CHAR) NOT NULL, Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT C_LabelCategory_Key PRIMARY KEY (C_LabelCategory_ID), CONSTRAINT C_LabelCategory_UU_idx UNIQUE (C_LabelCategory_UU))
;
...
-- Apr 15, 2022, 1:52:19 PM CEST
CREATE TABLE C_Label (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, C_Label_ID NUMBER(10) NOT NULL, C_Label_UU VARCHAR2(36 CHAR) DEFAULT NULL , C_LabelCategory_ID NUMBER(10) NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Name VARCHAR2(60 CHAR) NOT NULL, Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, Value VARCHAR2(40 CHAR) DEFAULT NULL , CONSTRAINT C_Label_Key PRIMARY KEY (C_Label_ID), CONSTRAINT C_Label_UU_idx UNIQUE (C_Label_UU))
;
...
-- Apr 15, 2022, 1:52:27 PM CEST
CREATE TABLE C_Label_Trl (AD_Client_ID NUMBER(10) NOT NULL, AD_Language VARCHAR2(6 CHAR) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, C_Label_ID NUMBER(10) NOT NULL, C_Label_Trl_UU VARCHAR2(36 CHAR) DEFAULT NULL , Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, IsTranslated CHAR(1) DEFAULT 'N' CHECK (IsTranslated IN ('Y','N')) NOT NULL, Name VARCHAR2(60 CHAR) NOT NULL, Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT C_Label_Trl_UU_idx UNIQUE (C_Label_Trl_UU))
;
...
-- Apr 15, 2022, 1:53:05 PM CEST
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 100, getDate(), 100,t.AD_Tree_ID, 200202, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=200202)
;
...
UPDATE AD_Field SET SeqNoGrid=0,IsDisplayedGrid='N', Updated=getDate(), UpdatedBy=100 WHERE AD_Field_ID=206966
;

-- Apr 15, 2022, 1:57:04 PM CEST
UPDATE AD_Field SET SeqNoGrid=0,IsDisplayedGrid='N', Updated=getDate(), UpdatedBy=100 WHERE AD_Field_ID=206965
;

-- Apr 15, 2022, 1:57:04 PM CEST
UPDATE AD_Field SET SeqNoGrid=10,IsDisplayedGrid='Y', Updated=getDate(), UpdatedBy=100 WHERE AD_Field_ID=206967
;

-- Apr 15, 2022, 1:57:04 PM CEST
UPDATE AD_Field SET SeqNoGrid=20,IsDisplayedGrid='Y', Updated=getDate(), UpdatedBy=100 WHERE AD_Field_ID=206968
;

-- Apr 15, 2022, 1:57:04 PM CEST
UPDATE AD_Field SET SeqNoGrid=30,IsDisplayedGrid='Y', Updated=getDate(), UpdatedBy=100 WHERE AD_Field_ID=206970
;

-- Apr 15, 2022, 1:57:04 PM CEST
UPDATE AD_Field SET SeqNoGrid=40,IsDisplayedGrid='Y', Updated=getDate(), UpdatedBy=100 WHERE AD_Field_ID=206971
;
...
-- Apr 15, 2022, 1:59:44 PM CEST
CREATE TABLE C_LabelAssignment (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, AD_Table_ID NUMBER(10) NOT NULL, C_LabelAssignment_ID NUMBER(10) NOT NULL, C_LabelAssignment_UU VARCHAR2(36 CHAR) DEFAULT NULL , Comments VARCHAR2(2000 CHAR) DEFAULT NULL , Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Record_ID NUMBER(10) NOT NULL, Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT C_LabelAssignment_Key PRIMARY KEY (C_LabelAssignment_ID), CONSTRAINT C_LabelAssignment_UU_idx UNIQUE (C_LabelAssignment_UU))
;
...
-- Apr 15, 2022, 2:00:07 PM CEST
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 100, getDate(), 100,t.AD_Tree_ID, 200203, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=200203)
;
...
-- Apr 15, 2022, 2:49:14 PM CEST
ALTER TABLE C_LabelAssignment ADD C_Label_ID NUMBER(10) NOT NULL
;
...
-- Apr 15, 2022, 2:58:28 PM CEST
ALTER TABLE C_LabelAssignment ADD C_LabelCategory_ID NUMBER(10) NOT NULL
;
...
UPDATE AD_Field SET SeqNoGrid=40,IsDisplayedGrid='Y', Updated=getDate(), UpdatedBy=100 WHERE AD_Field_ID=206981
;

-- Apr 15, 2022, 2:58:55 PM CEST
UPDATE AD_Field SET SeqNoGrid=50,IsDisplayedGrid='Y', Updated=getDate(), UpdatedBy=100 WHERE AD_Field_ID=206980
;

-- Apr 15, 2022, 2:58:55 PM CEST
UPDATE AD_Field SET SeqNoGrid=60,IsDisplayedGrid='Y', Updated=getDate(), UpdatedBy=100 WHERE AD_Field_ID=206978
;

-- Apr 15, 2022, 2:58:55 PM CEST
UPDATE AD_Field SET SeqNoGrid=70,IsDisplayedGrid='Y', Updated=getDate(), UpdatedBy=100 WHERE AD_Field_ID=206979
;
