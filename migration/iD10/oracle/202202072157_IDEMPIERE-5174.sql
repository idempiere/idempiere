...
UPDATE AD_User SET name='System (deprecated)',email='system deprecated @ idempiere.com',value='systemdeprecated',IsActive='N',password=NULL,Updated=TO_DATE('2022-02-07 21:52:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_User_ID=0
;
