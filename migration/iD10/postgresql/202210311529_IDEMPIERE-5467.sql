...
ALTER TABLE AD_InfoColumn ADD COLUMN IsRange CHAR(1) DEFAULT 'N' CHECK (IsRange IN ('Y','N')) NOT NULL
;
...
ALTER TABLE AD_InfoColumn ADD COLUMN DefaultValue2 VARCHAR(2000) DEFAULT NULL 
;
...
ALTER TABLE AD_InfoColumn ADD COLUMN Placeholder2 VARCHAR(255) DEFAULT NULL 
;
...
ALTER TABLE AD_InfoColumn_Trl ADD COLUMN Placeholder2 VARCHAR(255) DEFAULT NULL 
;
