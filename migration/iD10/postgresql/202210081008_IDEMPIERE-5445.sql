...
ALTER TABLE PA_ReportLine ADD COLUMN RoundingPrecision NUMERIC(10) DEFAULT NULL 
;
...
ALTER TABLE PA_ReportLine ADD COLUMN IsMultiplyPercentageBy100 CHAR(1) DEFAULT 'Y' CHECK (IsMultiplyPercentageBy100 IN ('Y','N')) NOT NULL
;
