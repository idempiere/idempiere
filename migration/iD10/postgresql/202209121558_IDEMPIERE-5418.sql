...
CREATE TABLE AD_ChartDatasource_Trl (AD_Client_ID NUMERIC(10) NOT NULL)
;
...
-- Sep 12, 2022, 4:00:40 PM CEST
ALTER TABLE AD_ChartDatasource_Trl ADD COLUMN AD_ChartDatasource_ID NUMERIC(10) NOT NULL
;
...
ALTER TABLE AD_ChartDatasource_Trl ADD COLUMN AD_ChartDatasource_Trl_UU VARCHAR(36) DEFAULT NULL 
;
...
-- Sep 12, 2022, 4:02:18 PM CEST
ALTER TABLE AD_ChartDatasource_Trl ADD COLUMN AD_Language VARCHAR(6) NOT NULL
;
...
ALTER TABLE AD_ChartDatasource_Trl ADD COLUMN AD_Org_ID NUMERIC(10) NOT NULL
;
...
ALTER TABLE AD_ChartDatasource_Trl ADD COLUMN Created TIMESTAMP DEFAULT statement_timestamp() NOT NULL
;
...
ALTER TABLE AD_ChartDatasource_Trl ADD COLUMN CreatedBy NUMERIC(10) NOT NULL
;
...
ALTER TABLE AD_ChartDatasource_Trl ADD COLUMN IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL
;
...
ALTER TABLE AD_ChartDatasource_Trl ADD COLUMN IsTranslated CHAR(1) CHECK (IsTranslated IN ('Y','N')) NOT NULL
;
...
ALTER TABLE AD_ChartDatasource_Trl ADD COLUMN Name VARCHAR(60) NOT NULL
;
...
ALTER TABLE AD_ChartDatasource_Trl ADD COLUMN Updated TIMESTAMP DEFAULT statement_timestamp() NOT NULL
;
...
-- Sep 12, 2022, 4:07:11 PM CEST
ALTER TABLE AD_ChartDatasource_Trl ADD COLUMN UpdatedBy NUMERIC(10) NOT NULL
;
...
INSERT INTO t_alter_column values('ad_chartdatasource_trl','AD_ChartDatasource_ID','NUMERIC(10)',null,null)
;
