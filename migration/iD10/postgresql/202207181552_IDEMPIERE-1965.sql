...
INSERT INTO AD_Menu (EntityType,Created,UpdatedBy,IsSummary,AD_Menu_ID,IsReadOnly,IsCentrallyMaintained,Name,Description,AD_Menu_UU,"action",AD_InfoWindow_ID,IsSOTrx,IsActive,CreatedBy,Updated,AD_Client_ID,AD_Org_ID) VALUES ('U',TO_TIMESTAMP('2014-06-05 13:39:02','YYYY-MM-DD HH24:MI:SS'),100,'N',200083,'N','Y','Generate Invoices (manual)','Select and generate invoices Info Window','56b27cac-0a4f-4531-8b56-96a7e5967e31','I',200011,'N','Y',100,TO_TIMESTAMP('2014-06-05 13:39:02','YYYY-MM-DD HH24:MI:SS'),0,0)
;
