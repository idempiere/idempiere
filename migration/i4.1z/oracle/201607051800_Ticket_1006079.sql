...
-- Jul 5, 2016 8:49:14 PM MYT
INSERT INTO AD_Column (SeqNoSelection,AD_Column_ID,IsAlwaysUpdateable,IsSyncDatabase,AD_Client_ID,AD_Org_ID,Updated,EntityType,IsSecure,IsEncrypted,IsParent,IsMandatory,IsIdentifier,SeqNo,Help,Version,FieldLength,IsKey,IsTranslated,Created,IsUpdateable,IsAutocomplete,IsAllowLogging,CreatedBy,IsAllowCopy,Description,ColumnName,Name,DefaultValue,IsSelectionColumn,AD_Column_UU,UpdatedBy,IsActive,IsToolbarButton,FKConstraintType,AD_Element_ID,AD_Reference_ID,AD_Table_ID) VALUES (0,212806,'N','Y',0,0,TO_DATE('2016-07-05 20:49:14','YYYY-MM-DD HH24:MI:SS'),'D','N','N','N','Y','N',0,'The Created field indicates the date that this record was created.',0,7,'N','N',TO_DATE('2016-07-05 20:49:14','YYYY-MM-DD HH24:MI:SS'),'N','N','N',100,'N','Date this record was created','Created','Created','SYSDATE','N','9b44d677-9e7a-4773-895a-5de84574cbe1',100,'Y','N','N',245,16,200210)
;
...
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.',0,1,'N','N',TO_DATE('2016-07-05 20:49:16','YYYY-MM-DD HH24:MI:SS'),'Y','N','Y',100,'N','The record is active in the system','IsActive','Active','Y','N','e86dd94b-8edd-4dc3-91c5-01e4fb268140',100,'Y','N','N',348,20,200210)
;
...
-- Jul 5, 2016 8:49:16 PM MYT
INSERT INTO AD_Column (SeqNoSelection,AD_Column_ID,IsAlwaysUpdateable,IsSyncDatabase,AD_Client_ID,AD_Org_ID,Updated,EntityType,IsSecure,IsEncrypted,IsParent,IsMandatory,IsIdentifier,SeqNo,Help,Version,FieldLength,IsKey,IsTranslated,Created,IsUpdateable,IsAutocomplete,IsAllowLogging,CreatedBy,IsAllowCopy,Description,ColumnName,Name,DefaultValue,IsSelectionColumn,AD_Column_UU,UpdatedBy,IsActive,IsToolbarButton,FKConstraintType,AD_Element_ID,AD_Reference_ID,AD_Table_ID) VALUES (0,212810,'N','Y',0,0,TO_DATE('2016-07-05 20:49:16','YYYY-MM-DD HH24:MI:SS'),'D','N','N','N','Y','N',0,'The Approved checkbox indicates if this document requires approval before it can be processed.',0,1,'N','N',TO_DATE('2016-07-05 20:49:16','YYYY-MM-DD HH24:MI:SS'),'Y','N','Y',100,'N','Indicates if this document requires approval','IsApproved','Approved','N','N','6ef2b833-9691-4353-ad1b-d2b09ab90803',100,'Y','N','N',351,20,200210)
;
...
INSERT INTO AD_Column (SeqNoSelection,AD_Column_ID,IsAlwaysUpdateable,IsSyncDatabase,AD_Client_ID,AD_Org_ID,Updated,EntityType,IsSecure,IsEncrypted,IsParent,IsMandatory,IsIdentifier,SeqNo,Help,Version,FieldLength,IsKey,IsTranslated,Created,IsUpdateable,IsAutocomplete,IsAllowLogging,CreatedBy,IsAllowCopy,Description,ColumnName,Name,DefaultValue,IsSelectionColumn,AD_Column_UU,UpdatedBy,IsActive,IsToolbarButton,FKConstraintType,AD_Element_ID,AD_Reference_ID,AD_Table_ID) VALUES (0,212812,'N','Y',0,0,TO_DATE('2016-07-05 20:49:17','YYYY-MM-DD HH24:MI:SS'),'D','N','N','N','Y','N',0,'The Updated field indicates the date that this record was updated.',0,7,'N','N',TO_DATE('2016-07-05 20:49:17','YYYY-MM-DD HH24:MI:SS'),'Y','N','Y',100,'N','Date this record was updated','Updated','Updated','SYSDATE','N','e52797cb-9333-4ade-b80f-d58594f31a17',100,'Y','N','N',607,16,200210)
;
...
-- Jul 5, 2016 8:49:18 PM MYT
INSERT INTO AD_Column (SeqNoSelection,AD_Column_ID,IsAlwaysUpdateable,IsSyncDatabase,AD_Client_ID,AD_Org_ID,Updated,EntityType,IsSecure,IsEncrypted,IsParent,IsMandatory,IsIdentifier,SeqNo,Help,Version,FieldLength,IsKey,IsTranslated,Created,IsUpdateable,IsAutocomplete,IsAllowLogging,CreatedBy,IsAllowCopy,Description,ColumnName,Name,IsSelectionColumn,AD_Column_UU,UpdatedBy,IsActive,IsToolbarButton,FKConstraintType,AD_Element_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID) VALUES (0,212813,'N','Y',0,0,TO_DATE('2016-07-05 20:49:18','YYYY-MM-DD HH24:MI:SS'),'D','N','N','N','Y','N',0,'The Updated By field indicates the user who updated this record.',0,22,'N','N',TO_DATE('2016-07-05 20:49:18','YYYY-MM-DD HH24:MI:SS'),'Y','N','Y',100,'N','User who updated this records','UpdatedBy','Updated By','N','3927ef9f-a095-4589-ab18-4fa7494ca478',100,'Y','N','D',608,18,110,200210)
;
...
-- Jul 5, 2016 8:49:20 PM MYT
INSERT INTO AD_Column (SeqNoSelection,AD_Column_ID,IsAlwaysUpdateable,IsSyncDatabase,AD_Client_ID,AD_Org_ID,Updated,EntityType,IsSecure,IsEncrypted,IsParent,IsMandatory,IsIdentifier,SeqNo,Version,FieldLength,IsKey,IsTranslated,AD_Process_ID,Created,IsUpdateable,IsAutocomplete,IsAllowLogging,CreatedBy,IsAllowCopy,Description,ColumnName,Name,IsSelectionColumn,AD_Column_UU,UpdatedBy,IsActive,IsToolbarButton,FKConstraintType,AD_Element_ID,AD_Reference_ID,AD_Table_ID) VALUES (0,212814,'N','Y',0,0,TO_DATE('2016-07-05 20:49:20','YYYY-MM-DD HH24:MI:SS'),'D','N','N','N','N','N',0,0,1,'N','N',200096,TO_DATE('2016-07-05 20:49:20','YYYY-MM-DD HH24:MI:SS'),'Y','N','N',100,'N','Accept suggested changes','AcceptSuggestion','Accept','N','6523b5b2-7f9e-4595-9976-1a0550ec9b35',100,'Y','N','N',203023,28,200210)
;
