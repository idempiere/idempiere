...
-- Nov 12, 2024, 11:06:44 AM CET
CREATE TABLE AD_UserDef_Theme (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, AD_Role_ID NUMBER(10) DEFAULT NULL , AD_User_ID NUMBER(10) DEFAULT NULL , AD_UserDef_Theme_ID NUMBER(10) NOT NULL, AD_UserDef_Theme_UU VARCHAR2(36 CHAR) DEFAULT NULL , Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, Description VARCHAR2(255 CHAR) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Name VARCHAR2(60 CHAR) NOT NULL, Theme VARCHAR2(60 CHAR) NOT NULL, Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT AD_UserDef_Theme_Key PRIMARY KEY (AD_UserDef_Theme_ID), CONSTRAINT AD_UserDef_Theme_UU_idx UNIQUE (AD_UserDef_Theme_UU))
;
...
-- Nov 12, 2024, 11:08:20 AM CET
CREATE TABLE AD_UserDef_Theme_Detail (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, AD_UserDef_Theme_Detail_ID NUMBER(10) NOT NULL, AD_UserDef_Theme_Detail_UU VARCHAR2(36 CHAR) DEFAULT NULL , AD_UserDef_Theme_ID NUMBER(10) NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, CurrentValue VARCHAR2(255 CHAR) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, NewValue VARCHAR2(255 CHAR) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT AD_UserDef_Theme_Detail_Key PRIMARY KEY (AD_UserDef_Theme_Detail_ID), CONSTRAINT AD_UserDef_Theme_Detail_UU_idx UNIQUE (AD_UserDef_Theme_Detail_UU))
;
...
-- Nov 12, 2024, 11:08:42 AM CET
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 10, getDate(), 10,t.AD_Tree_ID, 200238, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=200238)
;
...
ALTER TABLE AD_UserDef_Theme MODIFY Stylesheet VARCHAR2(512 CHAR) DEFAULT NULL 
;
