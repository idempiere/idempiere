...
SELECT register_migration_script('202402231345_IDEMPIERE-6025.sql') FROM dual;

SET SQLBLANKLINES ON
SET DEFINE OFF

-- Feb 23, 2024, 1:45:45 PM MYT
UPDATE AD_ViewComponent SET FromClause='FROM C_OrderLine l
