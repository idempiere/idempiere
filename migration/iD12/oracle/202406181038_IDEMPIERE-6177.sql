...
ALTER TABLE C_DocType ADD IsMInoutGenerate CHAR(1) DEFAULT 'N' CHECK (IsMInoutGenerate IN ('Y','N')) NOT NULL
;

-- Jun 18, 2024, 10:43:27 AM CEST
ALTER TABLE C_DocType ADD IsCInvoiceGenerate CHAR(1) DEFAULT 'N' CHECK (IsCInvoiceGenerate IN ('Y','N')) NOT NULL
;
