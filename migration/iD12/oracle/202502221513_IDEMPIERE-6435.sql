...
ALTER TABLE PA_DocumentStatus ADD IsHideWhenZero CHAR(1) DEFAULT 'N' CHECK (IsHideWhenZero IN ('Y','N')) NOT NULL
;
...
ALTER TABLE PA_DocumentStatus ADD Help VARCHAR2(4000 CHAR) DEFAULT NULL 
;
...
ALTER TABLE PA_DocumentStatus_Trl ADD Help VARCHAR2(4000 CHAR) DEFAULT NULL 
;
...
-- Feb 22, 2025, 3:30:25 PM CET
ALTER TABLE PA_DocumentStatus ADD Name_PrintColorZero_ID NUMBER(10) DEFAULT NULL 
;
...
-- Feb 7, 2026, 3:12:23 PM CET
ALTER TABLE PA_DocumentStatus ADD AD_FieldGroup_ID NUMBER(10) DEFAULT NULL 
;
...
-- Feb 7, 2026, 3:12:36 PM CET
ALTER TABLE PA_DocumentStatus ADD AD_Process_ID NUMBER(10) DEFAULT NULL 
;
...
-- Feb 7, 2026, 3:12:59 PM CET
ALTER TABLE PA_DocumentStatus ADD AD_InfoWindow_ID NUMBER(10) DEFAULT NULL 
;
