...
ALTER TABLE AD_ChangeLog ADD ExternalTraceId VARCHAR2(100 CHAR) DEFAULT NULL 
;
...
ALTER TABLE AD_PInstance ADD ExternalTraceId VARCHAR2(100 CHAR) DEFAULT NULL 
;
