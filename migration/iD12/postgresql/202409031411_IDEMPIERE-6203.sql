...
ALTER TABLE C_AcctSchema ADD COLUMN BackDateDay NUMERIC(10) DEFAULT NULL 
;
...
ALTER TABLE M_CostDetail ADD COLUMN BackDateProcessedOn TIMESTAMP DEFAULT NULL 
;
...
ALTER TABLE M_CostHistory ADD COLUMN BackDateProcessedOn TIMESTAMP DEFAULT NULL 
;
...
INSERT INTO t_alter_column values('t_fact_acct_history','Fact_Acct_ID','NUMERIC(10)',null,'NULL')
;
