...
UPDATE AD_Element SET Name='Activity Key', Description='Text key of the Activity', PrintName='Activity Key',Updated=TO_DATE('2013-01-15 21:15:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=53222
;
...
-- IDEMPIERE-539 Import GL Window does not allow Key Values for Activity, Campaign, Sales Region
UPDATE AD_PrintFormatItem pi SET PrintName='Activity Key', Name='Activity Key' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=53222)
;

-- Jan 15, 2013 9:15:50 PM CET
-- IDEMPIERE-539 Import GL Window does not allow Key Values for Activity, Campaign, Sales Region
UPDATE AD_Element SET Name='Campaign Key', Description='Text key of the Campaign', PrintName='Campaign Key',Updated=TO_DATE('2013-01-15 21:15:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=54241
;
...
-- IDEMPIERE-539 Import GL Window does not allow Key Values for Activity, Campaign, Sales Region
INSERT INTO AD_Column (IsSyncDatabase,IsEncrypted,Version,AD_Table_ID,AD_Column_ID,EntityType,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,AD_Client_ID,IsToolbarButton,IsAlwaysUpdateable) VALUES ('N','N',1,599,1000001,'D','N','N','N',0,'N',40,'N',10,'N',54241,'N','Y','7b723ab4-6cbc-49aa-882a-4b96f1b293f7','Y','CampaignValue','Text key of the Campaign','Campaign Key','Y',TO_DATE('2013-01-15 21:18:56','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_DATE('2013-01-15 21:18:56','YYYY-MM-DD HH24:MI:SS'),100,0,'N','N')
;
...
-- IDEMPIERE-539 Import GL Window does not allow Key Values for Activity, Campaign, Sales Region
INSERT INTO AD_Column (IsSyncDatabase,IsEncrypted,Version,AD_Table_ID,AD_Column_ID,EntityType,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,AD_Client_ID,IsToolbarButton,IsAlwaysUpdateable) VALUES ('N','N',1,599,1000002,'U','N','N','N',0,'N',40,'N',10,'N',1000000,'N','Y','602a3901-4ead-4d0e-bd75-f9e78f37e107','Y','SalesRegionValue','Text key of the Sales Region','Sales Region Key','Y',TO_DATE('2013-01-15 21:19:29','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_DATE('2013-01-15 21:19:29','YYYY-MM-DD HH24:MI:SS'),100,0,'N','N')
;
...
-- IDEMPIERE-539 Import GL Window does not allow Key Values for Activity, Campaign, Sales Region
INSERT INTO AD_Field (ColumnSpan,NumLines,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Description,Name,IsDisplayed,IsFieldOnly,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry) VALUES (2,1,'N',508,20,'N','N',1000001,515,'Y',1000001,'N','D','Text key of the Campaign','Campaign Key','Y','N','3dd3f08e-fb5c-4f83-92fe-1588db8def3b',100,0,TO_DATE('2013-01-15 21:22:35','YYYY-MM-DD HH24:MI:SS'),0,100,TO_DATE('2013-01-15 21:22:35','YYYY-MM-DD HH24:MI:SS'),'Y','Y',515,1,'N')
;
...
-- IDEMPIERE-539 Import GL Window does not allow Key Values for Activity, Campaign, Sales Region
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2013-01-15 21:24:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=7114
;

-- Jan 15, 2013 9:24:51 PM CET
-- IDEMPIERE-539 Import GL Window does not allow Key Values for Activity, Campaign, Sales Region
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2013-01-15 21:24:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=7157
;

-- Jan 15, 2013 9:30:08 PM CET
-- IDEMPIERE-539 Import GL Window does not allow Key Values for Activity, Campaign, Sales Region
UPDATE AD_Field SET SeqNo=515, SeqNoGrid=515,Updated=TO_DATE('2013-01-15 21:30:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000000
;

-- Jan 15, 2013 9:30:15 PM CET
-- IDEMPIERE-539 Import GL Window does not allow Key Values for Activity, Campaign, Sales Region
UPDATE AD_Field SET SeqNo=505, SeqNoGrid=505,Updated=TO_DATE('2013-01-15 21:30:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000001
;
