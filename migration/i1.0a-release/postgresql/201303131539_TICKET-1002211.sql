...
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Ref_List_ID,AD_Reference_ID,EntityType,Name,AD_Ref_List_UU,Value,CreatedBy,Created,Updated,UpdatedBy,IsActive,AD_Org_ID) VALUES (0,200135,200064,'D','All','298064ff-6e69-435f-aa0e-d156375339f5','A',100,TO_TIMESTAMP('2013-03-13 14:23:25','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2013-03-13 14:23:25','YYYY-MM-DD HH24:MI:SS'),100,'Y',0)
;
...
-- Ticket #1002211: Create Help pane for Bizidium
UPDATE AD_Val_Rule SET Code='AD_CtxHelp_ID IN (SELECT AD_CtxHelp_ID FROM AD_CtxHelp WHERE CtxType IS NULL OR CtxType IN (''A'', ''F''))',Updated=TO_TIMESTAMP('2013-03-13 14:26:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=200026
;

-- Mar 13, 2013 2:26:55 PM SGT
-- Ticket #1002211: Create Help pane for Bizidium
UPDATE AD_Val_Rule SET Code='AD_CtxHelp_ID IN (SELECT AD_CtxHelp_ID FROM AD_CtxHelp WHERE CtxType IS NULL OR CtxType IN (''A'', ''I''))',Updated=TO_TIMESTAMP('2013-03-13 14:26:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=200027
;

-- Mar 13, 2013 2:27:07 PM SGT
-- Ticket #1002211: Create Help pane for Bizidium
UPDATE AD_Val_Rule SET Code='AD_CtxHelp_ID IN (SELECT AD_CtxHelp_ID FROM AD_CtxHelp WHERE CtxType IS NULL OR CtxType IN (''A'', ''P''))',Updated=TO_TIMESTAMP('2013-03-13 14:27:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=200029
;

-- Mar 13, 2013 2:27:46 PM SGT
-- Ticket #1002211: Create Help pane for Bizidium
UPDATE AD_Val_Rule SET Code='AD_CtxHelp_ID IN (SELECT AD_CtxHelp_ID FROM AD_CtxHelp WHERE CtxType IS NULL OR CtxType IN (''A'', ''T''))',Updated=TO_TIMESTAMP('2013-03-13 14:27:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=200030
;

-- Mar 13, 2013 2:27:57 PM SGT
-- Ticket #1002211: Create Help pane for Bizidium
UPDATE AD_Val_Rule SET Code='AD_CtxHelp_ID IN (SELECT AD_CtxHelp_ID FROM AD_CtxHelp WHERE CtxType IS NULL OR CtxType IN (''A'', ''K''))',Updated=TO_TIMESTAMP('2013-03-13 14:27:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=200028
;

-- Mar 13, 2013 2:28:07 PM SGT
-- Ticket #1002211: Create Help pane for Bizidium
UPDATE AD_Val_Rule SET Code='AD_CtxHelp_ID IN (SELECT AD_CtxHelp_ID FROM AD_CtxHelp WHERE CtxType IS NULL OR CtxType IN (''A'', ''W''))',Updated=TO_TIMESTAMP('2013-03-13 14:28:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=200031
;

-- Mar 13, 2013 2:35:25 PM SGT
-- Ticket #1002211: Create Help pane for Bizidium
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Ref_List_ID,AD_Reference_ID,EntityType,Name,AD_Ref_List_UU,Value,CreatedBy,Created,Updated,UpdatedBy,IsActive,AD_Org_ID) VALUES (0,200136,200064,'D','Node','daeadda1-f591-4efe-92dc-9693b5fe2826','N',100,TO_TIMESTAMP('2013-03-13 14:35:24','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2013-03-13 14:35:24','YYYY-MM-DD HH24:MI:SS'),100,'Y',0)
;
...
-- Ticket #1002211: Create Help pane for Bizidium
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',122,10,'N','N',208804,'Y',201875,'N','D','Context Help','N','Y','7e1434c3-7b19-485c-8bee-c29c5ed60d7e',100,0,TO_TIMESTAMP('2013-03-13 14:37:33','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-03-13 14:37:33','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1002211: Create Help pane for Bizidium
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',122,1,'N','N',53304,'Y',201876,'N','EE01','Is Milestone','N','Y','584a97de-bea2-472d-8a8c-f48b682b46ec',100,0,TO_TIMESTAMP('2013-03-13 14:37:34','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-03-13 14:37:34','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1002211: Create Help pane for Bizidium
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',122,1,'N','N',53305,'Y',201877,'N','EE01','Is Subcontracting','N','Y','7888f993-bb3d-401d-a17f-1d0a764cd88b',100,0,TO_TIMESTAMP('2013-03-13 14:37:35','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-03-13 14:37:35','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1002211: Create Help pane for Bizidium
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',122,22,'N','N',53308,'Y',201878,'N','When there are two consecutive avtivity, you can sometimes save time by moving partial quantites from one activity to the next before the first activity as been completed.','EE01','Overlap Units are number of units that must be completed before they are moved the next activity','Overlap Units','N','Y','5fce61e0-a726-4a71-8b90-623562be95c0',100,0,TO_TIMESTAMP('2013-03-13 14:38:00','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-03-13 14:38:00','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1002211: Create Help pane for Bizidium
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',122,14,'N','N',53306,'Y',201880,'N','When Units by Cycles are defined the duration time is the total of time to manufactured the units','EE01','The Units by Cycles are defined for process type  Flow Repetitive Dedicated and  indicated the product to be manufactured on a production line for duration unit.','Units by Cycles','N','Y','3c87ab24-cedb-4d1c-a2ec-3ffa1358c665',100,0,TO_TIMESTAMP('2013-03-13 14:38:45','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-03-13 14:38:45','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
','EE01','The Yield is the percentage of a lot that is expected to be of acceptable wuality may fall below 100 percent','Yield %','N','Y','96f97be9-7de8-4311-969d-0d68acc5faf7',100,0,TO_TIMESTAMP('2013-03-13 14:39:08','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-03-13 14:39:08','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1002211: Create Help pane for Bizidium
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2013-03-13 14:40:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201875
;
