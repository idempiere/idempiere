...
-- 06 Mar 13 17:20:07
-- BF: “Error: ERROR: null value in column "assetvalueamt" violates not-null constraint”
...
-- 06 Mar 13 17:43:54
-- BF: Processed can't be a virtual column
...
-- 12 Mar 13 15:50:15
-- BF: "ERROR: null value in column "uselifemonths" violates not-null constraint
UPDATE AD_Column SET IsMandatory='N',Updated=TO_TIMESTAMP('2013-03-12 15:50:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=59517
;
...
-- 12 Mar 13 16:20:13
-- Missing message
INSERT INTO AD_Message (MsgType,MsgText,EntityType,Value,AD_Message_ID,IsActive,Updated,AD_Client_ID,AD_Org_ID,CreatedBy,Created,UpdatedBy) VALUES ('I','Asset Depreciation Amount','FA','AssetDepreciationAmt',20001,'Y',TO_TIMESTAMP('2013-03-12 16:20:13','YYYY-MM-DD HH24:MI:SS'),0,0,0,TO_TIMESTAMP('2013-03-12 16:20:13','YYYY-MM-DD HH24:MI:SS'),0)
;
