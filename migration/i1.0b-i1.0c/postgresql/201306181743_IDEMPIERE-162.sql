...
UPDATE AD_Process_Para SET IsMandatory='Y', DefaultValue='N',Updated=TO_TIMESTAMP('2013-06-18 17:43:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=200007
;
