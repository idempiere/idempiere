...
INSERT INTO C_Bank (C_Bank_UU,RoutingNo,C_Bank_ID,IsOwnBank,Name,AD_Org_ID,Updated,Created,CreatedBy,UpdatedBy,AD_Client_ID,IsActive) VALUES ('269f3083-6c14-4e08-bc65-2f9e91927cb0','POS Cash',200000,'Y','POS Cash',0,TO_DATE('2013-05-29 11:30:15','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2013-05-29 11:30:15','YYYY-MM-DD HH24:MI:SS'),100,100,11,'Y')
;

-- May 29, 2013 11:30:39 AM COT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO C_BankAccount (CurrentBalance,C_Currency_ID,IsDefault,BankAccountType,CreditLimit,C_BankAccount_ID,C_BankAccount_UU,CreatedBy,Created,Updated,AD_Org_ID,UpdatedBy,AD_Client_ID,IsActive,AccountNo,Value,Name,C_Bank_ID) VALUES (0,100,'N','B',0,200000,'4781b89e-ce6d-41c9-9c89-12d2db752b61',100,TO_DATE('2013-05-29 11:30:38','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2013-05-29 11:30:38','YYYY-MM-DD HH24:MI:SS'),11,100,11,'Y','HQ POS Cash','HQ POS Cash','HQ POS Cash',200000)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO C_BankAccountDoc (C_BankAccount_ID,PaymentRule,C_BankAccountDoc_ID,Check_PrintFormat_ID,CurrentNext,Name,C_BankAccountDoc_UU,Created,UpdatedBy,Updated,AD_Org_ID,CreatedBy,AD_Client_ID,IsActive) VALUES (200000,'B',200000,126,0,'HQ POS Cash','cdfacd83-2ca2-45a6-93f4-36215066c94d',TO_DATE('2013-05-29 11:30:54','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2013-05-29 11:30:54','YYYY-MM-DD HH24:MI:SS'),11,100,11,'Y')
;
