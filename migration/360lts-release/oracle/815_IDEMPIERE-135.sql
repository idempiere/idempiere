...
UPDATE AD_Element SET Name='User/Contact', PrintName='User',Updated=TO_DATE('2012-02-06 21:16:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=138
;
...
-- Feb 6, 2012 9:16:25 PM COT
UPDATE AD_PrintFormatItem pi SET PrintName='User', Name='User/Contact' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=138)
;

-- Feb 6, 2012 9:16:46 PM COT
UPDATE AD_Element_Trl SET IsTranslated='Y',Updated=TO_DATE('2012-02-06 21:16:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=138 AND AD_Language='es_CO'
;
