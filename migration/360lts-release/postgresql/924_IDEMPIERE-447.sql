...
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
ALTER TABLE C_BankAccount ADD COLUMN C_PaymentProcessor_ID NUMERIC(10) DEFAULT NULL 
;

-- Oct 3, 2012 3:53:12 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_Column SET EntityType='D',Updated=TO_TIMESTAMP('2012-10-03 15:53:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=200579
;

-- Oct 3, 2012 3:53:15 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
INSERT INTO t_alter_column values('c_bankaccount','C_PaymentProcessor_ID','NUMERIC(10)',null,'NULL')
;

-- Oct 3, 2012 3:53:54 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
INSERT INTO AD_Window (WindowType,IsSOTrx,IsDefault,IsBetaFunctionality,WinHeight,WinWidth,EntityType,Name,AD_Window_ID,Processing,AD_Window_UU,Created,Updated,AD_Org_ID,AD_Client_ID,IsActive,UpdatedBy,CreatedBy) VALUES ('M','Y','N','N',0,0,'D','Payment Processor',200015,'N','be2857c6-7fdf-4c81-9431-c31855562b5d',TO_TIMESTAMP('2012-10-03 15:53:54','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2012-10-03 15:53:54','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',100,100)
;
...
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_Column SET IsMandatory='N', IsUpdateable='N',Updated=TO_TIMESTAMP('2012-10-03 15:55:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=5057
;

-- Oct 3, 2012 3:56:02 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_Column SET IsParent='N',Updated=TO_TIMESTAMP('2012-10-03 15:56:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=5057
;

-- Oct 3, 2012 3:56:09 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
INSERT INTO t_alter_column values('c_paymentprocessor','C_BankAccount_ID','NUMERIC(10)',null,'NULL')
;

-- Oct 3, 2012 3:56:09 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
INSERT INTO t_alter_column values('c_paymentprocessor','C_BankAccount_ID',null,'NULL',null)
;

-- Oct 3, 2012 3:56:53 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_Table SET AccessLevel='6', AD_Window_ID=NULL,Updated=TO_TIMESTAMP('2012-10-03 15:56:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=398
;

-- Oct 3, 2012 3:57:12 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_Table SET AD_Window_ID=200015,Updated=TO_TIMESTAMP('2012-10-03 15:57:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=398
;
...
-- Oct 3, 2012 3:59:10 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_TreeNodeMM SET Parent_ID=218, SeqNo=3, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=200021
;
...
-- Oct 3, 2012 3:59:14 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_TreeNodeMM SET Parent_ID=175, SeqNo=7, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=200021
;

-- Oct 3, 2012 3:59:14 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_TreeNodeMM SET Parent_ID=175, SeqNo=8, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=361
;
...
-- Oct 3, 2012 3:59:22 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_TreeNodeMM SET Parent_ID=175, SeqNo=5, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=200021
;

-- Oct 3, 2012 3:59:22 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_TreeNodeMM SET Parent_ID=175, SeqNo=6, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=437
;

-- Oct 3, 2012 3:59:22 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_TreeNodeMM SET Parent_ID=175, SeqNo=7, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=240
;

-- Oct 3, 2012 3:59:22 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_TreeNodeMM SET Parent_ID=175, SeqNo=8, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=200021
;

-- Oct 3, 2012 3:59:22 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_TreeNodeMM SET Parent_ID=175, SeqNo=9, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=361
;
...
-- Oct 3, 2012 3:59:23 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_TreeNodeMM SET Parent_ID=175, SeqNo=4, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=200021
;

-- Oct 3, 2012 3:59:23 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_TreeNodeMM SET Parent_ID=175, SeqNo=5, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=171
;

-- Oct 3, 2012 3:59:23 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_TreeNodeMM SET Parent_ID=175, SeqNo=6, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=200021
;

-- Oct 3, 2012 3:59:23 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_TreeNodeMM SET Parent_ID=175, SeqNo=7, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=437
;

-- Oct 3, 2012 3:59:23 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_TreeNodeMM SET Parent_ID=175, SeqNo=8, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=240
;
...
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2012-10-03 16:07:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200593
;

-- Oct 3, 2012 4:09:00 PM SGT
-- IDEMPIERE-447 Abstract Payment Processor from Tenant configuration
UPDATE AD_Tab SET IsActive='N',Updated=TO_TIMESTAMP('2012-10-03 16:09:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=326
;
