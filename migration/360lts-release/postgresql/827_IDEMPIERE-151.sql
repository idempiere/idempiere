...
-- IDEMPIERE-151 - Create tab to maintain yearly sequences
UPDATE AD_Field SET IsReadOnly='Y', DefaultValue='@AD_Client_ID@',Updated=TO_TIMESTAMP('2012-03-15 15:09:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200043
;

-- Mar 15, 2012 3:09:29 PM WIT
-- IDEMPIERE-151 - Create tab to maintain yearly sequences
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2012-03-15 15:09:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200045
;

-- Mar 15, 2012 3:09:43 PM WIT
-- IDEMPIERE-151 - Create tab to maintain yearly sequences
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2012-03-15 15:09:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200044
;

-- Mar 15, 2012 3:09:48 PM WIT
-- IDEMPIERE-151 - Create tab to maintain yearly sequences
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2012-03-15 15:09:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200042
;

-- Mar 15, 2012 3:39:49 PM WIT
-- IDEMPIERE-151 - Create tab to maintain yearly sequences
UPDATE AD_Tab SET DisplayLogic='@StartNewYear@=''Y''',Updated=TO_TIMESTAMP('2012-03-15 15:39:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=200001
;

-- Mar 15, 2012 3:40:08 PM WIT
-- IDEMPIERE-151 - Create tab to maintain yearly sequences
UPDATE AD_Field SET DefaultValue='@AD_Org_ID@',Updated=TO_TIMESTAMP('2012-03-15 15:40:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200045
;

-- Mar 15, 2012 3:41:45 PM WIT
-- IDEMPIERE-151 - Create tab to maintain yearly sequences
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2012-03-15 15:41:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200045
;
