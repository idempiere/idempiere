...
UPDATE AD_PrintTableFormat SET HdrStroke=2, LineStroke=1,Updated=TO_TIMESTAMP('2015-07-28 12:36:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_PrintTableFormat_ID=100
;
