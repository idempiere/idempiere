...
public class MReportLine extends X_PA_ReportLine
{
	...
	public String getSourceColumnName()
	{
		...
		for (int i = 0; i < m_sources.length; i++)
		{
			String col = AcctModelServices.getAcctSchemaElementModelService().getColumnName (m_sources[i].getElementType());
	...
	public String getSourceValueQuery()
	{
		if (m_sources != null && m_sources.length > 0)
			return AcctModelServices.getAcctSchemaElementModelService().getValueQuery(m_sources[0].getElementType());
		return null;
	}	//
