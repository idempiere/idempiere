...
/** Generated Model for T_Fact_Acct_History
 *  @author iDempiere (generated)
 *  @version Release 13 - $Id$ */
@org.adempiere.base.Model(table="T_Fact_Acct_History")
public class X_T_Fact_Acct_History extends PO implements I_T_Fact_Acct_History, I_Persistent
{
    ...
    {
      super (ctx, T_Fact_Acct_History_UU, trxName);
      /** if (T_Fact_Acct_History_UU == null)
        {
        } */
    }

    /** Standard Constructor */
    public X_T_Fact_Acct_History (Properties ctx, String T_Fact_Acct_History_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, T_Fact_Acct_History_UU, trxName, virtualColumns);
      /** if (T_Fact_Acct_History_UU == null)
        {
        } */
    }
    ...
    /** Load Constructor */
    public X_T_Fact_Acct_History (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_T_Fact_Acct_History[")
