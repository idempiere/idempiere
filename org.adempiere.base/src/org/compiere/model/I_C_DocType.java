...
public interface I_C_DocType 
{
    ...
    public static final String COLUMNNAME_Rounding = "Rounding";
    ...
    /** Column name RoundingCharge_ID */
    public static final String COLUMNNAME_RoundingCharge_ID = "RoundingCharge_ID";
