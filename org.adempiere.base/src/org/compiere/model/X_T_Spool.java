...
@org.adempiere.base.Model(table="T_Spool")
public class X_T_Spool extends PO implements I_T_Spool, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_T_Spool (Properties ctx, int T_Spool_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, T_Spool_ID, trxName, virtualColumns);
      /** if (T_Spool_ID == 0)
        {
			setAD_PInstance_ID (0);
			setMsgText (null);
    ...
    /** Standard Constructor */
    public X_T_Spool (Properties ctx, String T_Spool_UU, String trxName)
    {
      super (ctx, T_Spool_UU, trxName);
      /** if (T_Spool_UU == null)
        {
			setAD_PInstance_ID (0);
			setMsgText (null);
    ...
    /** Standard Constructor */
    public X_T_Spool (Properties ctx, String T_Spool_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, T_Spool_UU, trxName, virtualColumns);
      /** if (T_Spool_UU == null)
        {
			setAD_PInstance_ID (0);
			setMsgText (null);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_T_Spool[")
