	...
	protected boolean getOrCreateCombination()
	{
						...
						|| is_ValueChanged("User2_ID"))))
		{
			...
			for (IAcctSchemaElementInfo elem : AcctInfoServices.getAcctSchemaElementInfoService().getAcctSchemaElements(as)) {
				...
				if (IAcctSchemaElementConstants.ELEMENTTYPE_BPartner.equals(et) && getC_BPartner_ID() == 0)
					errorFields += "@" + COLUMNNAME_C_BPartner_ID + "@, ";
				if (IAcctSchemaElementConstants.ELEMENTTYPE_Campaign.equals(et) && getC_Campaign_ID() == 0)
					errorFields += "@" + COLUMNNAME_C_Campaign_ID + "@, ";
				if (IAcctSchemaElementConstants.ELEMENTTYPE_Organization.equals(et) && getAD_Org_ID() == 0)
					errorFields += "@" + COLUMNNAME_AD_Org_ID + "@, ";
				if (IAcctSchemaElementConstants.ELEMENTTYPE_OrgTrx.equals(et) && getAD_OrgTrx_ID() == 0)
					errorFields += "@" + COLUMNNAME_AD_OrgTrx_ID + "@, ";
				if (IAcctSchemaElementConstants.ELEMENTTYPE_Product.equals(et) && getM_Product_ID() == 0)
					errorFields += "@" + COLUMNNAME_M_Product_ID + "@, ";
				if (IAcctSchemaElementConstants.ELEMENTTYPE_Project.equals(et) && getC_Project_ID() == 0)
					errorFields += "@" + COLUMNNAME_C_Project_ID + "@, ";
				if (IAcctSchemaElementConstants.ELEMENTTYPE_SalesRegion.equals(et) && getC_SalesRegion_ID() == 0)
					errorFields += "@" + COLUMNNAME_C_SalesRegion_ID + "@, ";
				if (IAcctSchemaElementConstants.ELEMENTTYPE_UserElementList1.equals(et) && getUser1_ID() == 0)
					errorFields += "@" + COLUMNNAME_User1_ID + "@, ";
				if (IAcctSchemaElementConstants.ELEMENTTYPE_UserElementList2.equals(et) && getUser2_ID() == 0)
					errorFields += "@" + COLUMNNAME_User2_ID + "@, ";
				if (IAcctSchemaElementConstants.ELEMENTTYPE_Department.equals(et) && getC_Department_ID() == 0)
					errorFields += "@" + COLUMNNAME_C_Department_ID + "@, ";
				if (IAcctSchemaElementConstants.ELEMENTTYPE_CostCenter.equals(et) && getC_CostCenter_ID() == 0)
					errorFields += "@" + COLUMNNAME_C_CostCenter_ID + "@, ";
				if (IAcctSchemaElementConstants.ELEMENTTYPE_Employee.equals(et) && getC_Employee_ID() == 0)
					errorFields += "@" + COLUMNNAME_C_Employee_ID + "@, ";
				if (IAcctSchemaElementConstants.ELEMENTTYPE_Warehouse.equals(et) && getM_Warehouse_ID() == 0)
					errorFields += "@" + COLUMNNAME_M_Warehouse_ID + "@, ";
				if (IAcctSchemaElementConstants.ELEMENTTYPE_Charge.equals(et) && getC_Charge_ID() == 0)
					errorFields += "@" + COLUMNNAME_C_Charge_ID + "@, ";
				if (IAcctSchemaElementConstants.ELEMENTTYPE_AttributeSetInstance.equals(et) && getM_AttributeSetInstance_ID() == 0)
