...
public class MSysConfig extends X_AD_SysConfig
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5500019902537048269L;
    ...
    public static final String PASSWORD_RESET_CODE_EXPIRY_MINUTES = "PASSWORD_RESET_CODE_EXPIRY_MINUTES";
    public static final String PASSWORD_RESET_CODE_LENGTH = "PASSWORD_RESET_CODE_LENGTH";
    public static final String PASSWORD_RESET_MAX_ATTEMPTS = "PASSWORD_RESET_MAX_ATTEMPTS";
    public static final String PASSWORD_RESET_MAX_REQUESTS_PER_HOUR = "PASSWORD_RESET_MAX_REQUESTS_PER_HOUR";
    public static final String PASSWORD_RESET_REQUEST_COOLDOWN_SECONDS = "PASSWORD_RESET_REQUEST_COOLDOWN_SECONDS";
    public static final String PASSWORD_RESET_SERVICE_CLASS = "PASSWORD_RESET_SERVICE_CLASS";
    public static final String PASSWORD_RESET_VERIFIED_TOKEN_EXPIRY_MINUTES = "PASSWORD_RESET_VERIFIED_TOKEN_EXPIRY_MINUTES";
