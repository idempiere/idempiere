...
public class MMovementLineMA extends X_M_MovementLineMA
{
	...
	{
		DateMaterialPolicy = MStorageOnHand.resolveLineMADatePolicy(
			line.getM_Product_ID(), M_AttributeSetInstance_ID, DateMaterialPolicy,
			line.getParent().getMovementDate(), line.get_TrxName());
