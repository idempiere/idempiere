...
public class Translation implements IApplication
{
	...
	/**	DTD						*/
	public static final String DTD = "<!DOCTYPE idempiereTrl PUBLIC \"-//iDempiere//DTD iDempiere Translation 1.0//EN\" \"https://jenkins.idempiere.org/job/iDempiere/ws/utils_dev/trl/idempiereTrl.dtd\">";
	/**	XML Element Tag			*/
