...
public class DocActionDelegate<T extends PO & DocAction> implements DocAction {
	...
	public String prepareIt() {
		...
		if (doctype >= 0) {
			...
			AcctModelServices.getAcctSchemaModelService().testBackDateTrxAllowed(getCtx(), date, get_TrxName());
		}
	...
	private void setDefiniteDocumentNo() {
		...
		if (doctype >= 0) {
			...
			AcctModelServices.getAcctSchemaModelService().testBackDateTrxAllowed(getCtx(), (dateacct != null ? dateacct : datetrx), get_TrxName());
			...
			if (dt.isOverwriteDateOnComplete()) {
				...
				if (dateacct != null && dateacct.before(datetrx)) {
					...
					AcctModelServices.getAcctSchemaModelService().testBackDateTrxAllowed(getCtx(), datetrx, get_TrxName());
				}
			}
