...
public class MarkdownRendererImpl implements IMarkdownRenderer {
	...
	@Override
	public String renderToHtml(String inputText, boolean autoLink, String baseURL) {
		...
		if (autoLink || !Util.isEmpty(baseURL, true))
	...
	private class LinkAttributeProvider implements AttributeProvider {
		...
		private LinkAttributeProvider(String baseURL) {
