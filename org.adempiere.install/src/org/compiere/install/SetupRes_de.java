...
public class SetupRes_de extends ListResourceBundle
{
	...
	{ "UnableToConnect", 		"Keine Verbindung zur iDempiere-Webseite" },
	//
	{ "AdempiereHomeInfo", 		"iDempiere-Hauptverzeichnis" },
	...
	{ "DatabaseUserInfo", 		"Name iDempiere-DB-User" },
	{ "DatabaseUser", 			"iDempiere-DB-User" },
	{ "DatabasePasswordInfo", 	"Passwort iDempiere-DB-User" },
	...
	{ "AdminEMailInfo", 		"iDempiere Administrator-E-Mail" },
	...
	{ "JNPPort", 				"JNP-Port" },
	{ "MailUserInfo", 			"Name iDempiere-Mail-User" },
	{ "MailUser", 				"Mail-User" },
	{ "MailPasswordInfo", 		"Passwort iDempiere-Mail-User" },
	...
	{ "ErrorAdempiereHome", 	"Fehler bei iDempiere-Home" },
