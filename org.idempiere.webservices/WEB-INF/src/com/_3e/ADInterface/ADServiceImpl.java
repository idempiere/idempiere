 ...
 *
 */
@WebService(endpointInterface="com._3e.ADInterface.ADService", serviceName="ADService", targetNamespace="http://3e.pl/ADInterface")
...
//	method to convert Document to String
    ...
    void authenticate(String webServiceName, String method) {
    	if (!m_cs.isLoggedIn()) 
    		throw new IdempiereServiceFault( new Exception( "You need to login" ) );
    ...
    public WindowTabDataDocument getDataRow(int WindowNo, int TabNo, int RowNo )   {
    ...
    public WindowTabDataDocument updateDataRow(int WindowNo, int TabNo, int RowNo, WindowTabDataDocument data )   {
    ...
    private void fillDataRow( DataRow dr, WWindowStatus ws, boolean handleLookups, boolean onlyUpdated )   {
    ...
    public WindowTabDataDocument saveDataRow(int WindowNo, int TabNo, int RowNo, WindowTabDataDocument data ) {
	...
	public WindowTabDataDocument addNewDataRow(int WindowNo, int TabNo )	{
	...
	public WindowTabDataDocument deleteDataRow(int WindowNo, int TabNo, int RowNo )	{
	...
	public WindowTabDataDocument ignoreDataRow(int WindowNo, int TabNo, int RowNo )	{
	...
	public WindowTabDataDocument refreshDataRow(int WindowNo, int TabNo, int RowNo )	{
    ...
    public LocationDocument getLocation(@WebParam(name="req", targetNamespace="http://3e.pl/ADInterface") LocationDocument req )
    {
	...
	public StandardResponseDocument setDocAction(int WindowNo, int TabNo, int RowNo, String ColName, String docAction )
	{
