...
public class FavoriteSimpleTreeModel extends SimpleTreeModel implements EventListener<Event>, TreeitemRenderer<Object>
{
	...
	private int							currSelectedNodeID	= 0;
	...
	public static FavoriteSimpleTreeModel initADTree(Tree tree, String trxName)
	{
		...
		treeModel.currSelectedNodeID = root.getNode_ID();
		...
		if (Events.ON_CLICK.equals(eventName) || Events.ON_SELECT.equals(eventName))
		{
			...
			if (comp instanceof Treerow)
			{
				...
				else if (!mtn.isSummary())
				{
					...
					setSelectedNodeID(mtn.getParent_ID());
				}
				else
				{
					setSelectedNodeID(mtn.getNode_ID());
				}
			}
		}
	...
	{
		return currSelectedNodeID;
	}

	/**
	 * Set the current selected Menu/Folder node in Tree.
	 * 
	 * @param nodeID
	 */
	public void setSelectedNodeID(int nodeID)
	{
		currSelectedNodeID = nodeID;
	}
