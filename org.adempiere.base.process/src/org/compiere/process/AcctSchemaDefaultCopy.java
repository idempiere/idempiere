	...
	protected String doIt () throws Exception
	{
		...
		if (p_CopyOverwriteAcct)
		{
			sql = new StringBuilder("UPDATE M_Product_Category_Acct pa ")
				.append("SET P_Revenue_Acct=").append(acct.getAcctSchemaDefault().getP_Revenue_Acct())
				.append(", P_Expense_Acct=").append(acct.getAcctSchemaDefault().getP_Expense_Acct())
				.append(", P_CostAdjustment_Acct=").append(acct.getAcctSchemaDefault().getP_CostAdjustment_Acct())
				.append(", P_InventoryClearing_Acct=").append(acct.getAcctSchemaDefault().getP_InventoryClearing_Acct())
				.append(", P_Asset_Acct=").append(acct.getAcctSchemaDefault().getP_Asset_Acct())
				.append(", P_COGS_Acct=").append(acct.getAcctSchemaDefault().getP_COGS_Acct())
				.append(", P_PurchasePriceVariance_Acct=").append(acct.getAcctSchemaDefault().getP_PurchasePriceVariance_Acct())
				.append(", P_InvoicePriceVariance_Acct=").append(acct.getAcctSchemaDefault().getP_InvoicePriceVariance_Acct())
				.append(", P_AverageCostVariance_Acct=").append(acct.getAcctSchemaDefault().getP_AverageCostVariance_Acct())
				.append(", P_TradeDiscountRec_Acct=").append(acct.getAcctSchemaDefault().getP_TradeDiscountRec_Acct())
				.append(", P_TradeDiscountGrant_Acct=").append(acct.getAcctSchemaDefault().getP_TradeDiscountGrant_Acct())
				.append(", P_RateVariance_Acct=").append(acct.getAcctSchemaDefault().getP_RateVariance_Acct())
				.append(", P_LandedCostClearing_Acct=").append(acct.getAcctSchemaDefault().getP_LandedCostClearing_Acct())
		...
		if (p_CopyOverwriteAcct)
		{
			sql = new StringBuilder("UPDATE C_BP_Group_Acct a ")
				.append("SET C_Receivable_Acct=").append(acct.getAcctSchemaDefault().getC_Receivable_Acct());
			if (acct.getAcctSchemaDefault().getC_Receivable_Services_Acct() > 0)
				sql.append(", C_Receivable_Services_Acct=").append(acct.getAcctSchemaDefault().getC_Receivable_Services_Acct());
			sql.append(", C_Prepayment_Acct=").append(acct.getAcctSchemaDefault().getC_Prepayment_Acct())
				.append(", V_Liability_Acct=").append(acct.getAcctSchemaDefault().getV_Liability_Acct());
			if (acct.getAcctSchemaDefault().getV_Liability_Services_Acct() > 0)
				sql.append(", V_Liability_Services_Acct=").append(acct.getAcctSchemaDefault().getV_Liability_Services_Acct());
			sql.append(", V_Prepayment_Acct=").append(acct.getAcctSchemaDefault().getV_Prepayment_Acct())
				.append(", PayDiscount_Exp_Acct=").append(acct.getAcctSchemaDefault().getPayDiscount_Exp_Acct())
				.append(", PayDiscount_Rev_Acct=").append(acct.getAcctSchemaDefault().getPayDiscount_Rev_Acct())
				.append(", WriteOff_Acct=").append(acct.getAcctSchemaDefault().getWriteOff_Acct())
				.append(", NotInvoicedReceipts_Acct=").append(acct.getAcctSchemaDefault().getNotInvoicedReceipts_Acct())
				.append(", UnEarnedRevenue_Acct=").append(acct.getAcctSchemaDefault().getUnEarnedRevenue_Acct())
				.append(", Updated=getDate(), UpdatedBy=0 ")
...
//IDEMPIERE-362 Hide things that don't work on iDempiere
		...
		if (p_CopyOverwriteAcct)
		{
			sql = new StringBuilder("UPDATE M_Warehouse_Acct a ")
				.append("SET W_Differences_Acct=").append(acct.getAcctSchemaDefault().getW_Differences_Acct())
				.append(", Updated=getDate(), UpdatedBy=0 ")
				.append("WHERE a.C_AcctSchema_ID=").append(p_C_AcctSchema_ID)
		...
		if (p_CopyOverwriteAcct)
		{
			sql = new StringBuilder("UPDATE C_Project_Acct a ")
				.append("SET PJ_Asset_Acct=").append(acct.getAcctSchemaDefault().getPJ_Asset_Acct())
				.append(", PJ_WIP_Acct=").append(acct.getAcctSchemaDefault().getPJ_Asset_Acct())
				.append(", Updated=getDate(), UpdatedBy=0 ")
				.append("WHERE a.C_AcctSchema_ID=").append(p_C_AcctSchema_ID)
...
//IDEMPIERE-362 Hide things that don't work on iDempiere
		...
		if (p_CopyOverwriteAcct)
		{
			sql = new StringBuilder("UPDATE C_Tax_Acct a ")
				.append("SET T_Due_Acct=").append(acct.getAcctSchemaDefault().getT_Due_Acct())
				.append(", T_Credit_Acct=").append(acct.getAcctSchemaDefault().getT_Credit_Acct())
				.append(", T_Expense_Acct=").append(acct.getAcctSchemaDefault().getT_Expense_Acct())
				.append(", Updated=getDate(), UpdatedBy=0 ")
				.append("WHERE a.C_AcctSchema_ID=").append(p_C_AcctSchema_ID)
		...
		if (p_CopyOverwriteAcct)
		{
			sql = new StringBuilder("UPDATE C_BankAccount_Acct a ")
				.append("SET B_InTransit_Acct=").append(acct.getAcctSchemaDefault().getB_InTransit_Acct())
				.append(", B_Asset_Acct=").append(acct.getAcctSchemaDefault().getB_Asset_Acct())
				.append(", B_InterestRev_Acct=").append(acct.getAcctSchemaDefault().getB_InterestRev_Acct())
				.append(", B_InterestExp_Acct=").append(acct.getAcctSchemaDefault().getB_InterestExp_Acct())
				.append(", B_UnallocatedCash_Acct=").append(acct.getAcctSchemaDefault().getB_UnallocatedCash_Acct())
				.append(", B_PaymentSelect_Acct=").append(acct.getAcctSchemaDefault().getB_PaymentSelect_Acct())
				.append(", Updated=getDate(), UpdatedBy=0 ")
				.append("WHERE a.C_AcctSchema_ID=").append(p_C_AcctSchema_ID)
		...
		if (p_CopyOverwriteAcct)
		{
			sql = new StringBuilder("UPDATE C_Charge_Acct a ")
				.append("SET Ch_Expense_Acct=").append(acct.getAcctSchemaDefault().getCh_Expense_Acct())
				.append(", Updated=getDate(), UpdatedBy=0 ")
				.append("WHERE a.C_AcctSchema_ID=").append(p_C_AcctSchema_ID)
		...
		if (p_CopyOverwriteAcct)
		{
			sql = new StringBuilder("UPDATE C_Cashbook_Acct a ")
				.append("SET CB_Asset_Acct=").append(acct.getAcctSchemaDefault().getCB_Asset_Acct())
				.append(", CB_Differences_Acct=").append(acct.getAcctSchemaDefault().getCB_Differences_Acct())
				.append(", CB_CashTransfer_Acct=").append(acct.getAcctSchemaDefault().getCB_CashTransfer_Acct())
				.append(", CB_Expense_Acct=").append(acct.getAcctSchemaDefault().getCB_Expense_Acct())
				.append(", CB_Receipt_Acct=").append(acct.getAcctSchemaDefault().getCB_Receipt_Acct())
				.append(", Updated=getDate(), UpdatedBy=0 ")
				.append("WHERE a.C_AcctSchema_ID=").append(p_C_AcctSchema_ID)
