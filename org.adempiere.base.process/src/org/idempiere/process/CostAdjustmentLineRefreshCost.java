...
public class CostAdjustmentLineRefreshCost extends SvrProcess {
	...
	protected String doIt() throws Exception {
		...
		MCost cost = product.getCostingRecord(as, line.getAD_Org_ID(), line.getM_AttributeSetInstance_ID(), line.getM_Inventory().getCostingMethod(), line.getM_Inventory().getMovementDate());
		if (cost != null) {
