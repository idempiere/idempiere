...
UPDATE AD_Element SET Name='Show on Login', PrintName='Show on Login',Updated=TO_TIMESTAMP('2013-11-06 15:30:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=202569
;
