...
UPDATE AD_Menu SET IsActive='Y',Updated=TO_DATE('2012-12-14 18:20:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=484
;
...
-- Dec 14, 2012 6:21:02 PM CET
-- IDEMPIERE-246 Integrate Manufacturing Light
UPDATE AD_TreeNodeMM SET Parent_ID=53066, SeqNo=1, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=53088
;

-- Dec 14, 2012 6:21:02 PM CET
-- IDEMPIERE-246 Integrate Manufacturing Light
UPDATE AD_TreeNodeMM SET Parent_ID=53066, SeqNo=2, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=53068
;

-- Dec 14, 2012 6:21:02 PM CET
-- IDEMPIERE-246 Integrate Manufacturing Light
UPDATE AD_TreeNodeMM SET Parent_ID=53066, SeqNo=3, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=53185
;

-- Dec 14, 2012 6:21:02 PM CET
-- IDEMPIERE-246 Integrate Manufacturing Light
UPDATE AD_TreeNodeMM SET Parent_ID=53066, SeqNo=4, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=445
;

-- Dec 14, 2012 6:21:02 PM CET
-- IDEMPIERE-246 Integrate Manufacturing Light
UPDATE AD_TreeNodeMM SET Parent_ID=53066, SeqNo=5, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=53184
;
...
-- Dec 14, 2012 6:21:02 PM CET
-- IDEMPIERE-246 Integrate Manufacturing Light
UPDATE AD_TreeNodeMM SET Parent_ID=53066, SeqNo=9, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=53188
;
...
-- Dec 14, 2012 6:21:03 PM CET
-- IDEMPIERE-246 Integrate Manufacturing Light
UPDATE AD_TreeNodeMM SET Parent_ID=183, SeqNo=16, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=53253
;

-- Dec 14, 2012 6:21:03 PM CET
-- IDEMPIERE-246 Integrate Manufacturing Light
UPDATE AD_TreeNodeMM SET Parent_ID=183, SeqNo=17, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=426
;
