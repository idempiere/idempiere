...
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
UPDATE AD_Column SET EntityType='D',Updated=TO_DATE('2013-10-01 18:54:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=210872
;

-- Oct 1, 2013 6:54:11 PM SGT
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
ALTER TABLE AD_Column ADD FKConstraintType CHAR(1) DEFAULT NULL 
;

-- Oct 1, 2013 6:54:54 PM SGT
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,Created,CreatedBy,Updated,IsActive,IsDisplayedGrid,AD_Client_ID,ColumnSpan) VALUES ('N',101,36,'N','N',60388,440,'Y',202517,'N','D','AD_Column_UU','e9b392b1-3b5a-41c4-a7b7-4c67a425a034','N','N',100,0,TO_DATE('2013-10-01 18:54:53','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2013-10-01 18:54:53','YYYY-MM-DD HH24:MI:SS'),'Y','N',0,2)
;
...
-- Oct 1, 2013 6:54:55 PM SGT
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,Created,CreatedBy,Updated,IsActive,AD_Client_ID,ColumnSpan) VALUES ('N',101,1,'N','N',210872,460,'Y',202519,'N','D','Constraint Type','10745686-bf57-4d98-bd86-52b134ec6b99','Y','N',100,0,TO_DATE('2013-10-01 18:54:55','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2013-10-01 18:54:55','YYYY-MM-DD HH24:MI:SS'),'Y',0,2)
;

-- Oct 1, 2013 6:55:41 PM SGT
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
UPDATE AD_Field SET SeqNoGrid=460,Updated=TO_DATE('2013-10-01 18:55:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202519
;

-- Oct 1, 2013 6:56:16 PM SGT
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
INSERT INTO AD_FieldGroup (FieldGroupType,EntityType,IsCollapsedByDefault,Name,AD_FieldGroup_UU,AD_FieldGroup_ID,Created,CreatedBy,Updated,AD_Org_ID,UpdatedBy,IsActive,AD_Client_ID) VALUES ('C','D','Y','Foreign Key','c1abd52c-f048-4007-9536-dc09e4c74fed',200016,TO_DATE('2013-10-01 18:56:15','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2013-10-01 18:56:15','YYYY-MM-DD HH24:MI:SS'),0,100,'Y',0)
;

-- Oct 1, 2013 6:56:23 PM SGT
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
UPDATE AD_Field SET AD_FieldGroup_ID=200016, SeqNoGrid=450,Updated=TO_DATE('2013-10-01 18:56:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202518
;

-- Oct 1, 2013 6:56:39 PM SGT
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
UPDATE AD_Field SET IsSameLine='Y', AD_FieldGroup_ID=200016, XPosition=4,Updated=TO_DATE('2013-10-01 18:56:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202519
;
...
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
UPDATE AD_Column SET DefaultValue='N',Updated=TO_DATE('2013-10-02 16:44:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=210872
;

-- Oct 2, 2013 4:45:15 PM SGT
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
ALTER TABLE AD_Column MODIFY FKConstraintType CHAR(1) DEFAULT 'N'
;

-- Oct 2, 2013 4:45:30 PM SGT
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
UPDATE AD_Field SET AD_FieldGroup_ID=NULL,Updated=TO_DATE('2013-10-02 16:45:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202518
;

-- Oct 2, 2013 4:45:34 PM SGT
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
UPDATE AD_Field SET AD_FieldGroup_ID=NULL,Updated=TO_DATE('2013-10-02 16:45:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202519
;

-- Oct 2, 2013 4:51:29 PM SGT
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
UPDATE AD_Field SET DisplayLogic='@AD_Reference_ID@=19 | @AD_Reference_ID@=30 | @AD_Reference_ID@=18 | @AD_Reference_ID@=21 | @AD_Reference_ID@=25 | @AD_Reference_ID@=31 | @AD_Reference_ID@=35 | @AD_Reference_ID@=33 | @AD_Reference_ID@=32 | @AD_Reference_ID@=27 | @AD_Reference_ID@=53370',Updated=TO_DATE('2013-10-02 16:51:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202519
;

-- Oct 2, 2013 4:51:36 PM SGT
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
UPDATE AD_Field SET DisplayLogic='@AD_Reference_ID@=19 | @AD_Reference_ID@=30 | @AD_Reference_ID@=18 | @AD_Reference_ID@=21 | @AD_Reference_ID@=25 | @AD_Reference_ID@=31 | @AD_Reference_ID@=35 | @AD_Reference_ID@=33 | @AD_Reference_ID@=32 | @AD_Reference_ID@=27 | @AD_Reference_ID@=53370',Updated=TO_DATE('2013-10-02 16:51:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202518
;

-- Oct 2, 2013 4:53:52 PM SGT
-- IDEMPIERE-1132 Improve AD_Index; AD_View; foreign keys management
UPDATE AD_Field SET DisplayLength=20,Updated=TO_DATE('2013-10-02 16:53:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202518
;
