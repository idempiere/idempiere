...
# Export
$DOCKER_EXEC expdp "$1"/"$2"@"$DB_CONNECTION" DIRECTORY=ADEMPIERE_DATA_PUMP_DIR DUMPFILE="$DATA_ENDPOINT"ExpDat_"$DATE".dmp LOGFILE="$DATA_ENDPOINT"ExpDat_"$DATE".log EXCLUDE=STATISTICS SCHEMAS="$1" CREDENTIAL=NULL
