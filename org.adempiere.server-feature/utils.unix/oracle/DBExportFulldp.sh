...
$DOCKER_EXEC expdp "$1"@"$DB_CONNECTION" DIRECTORY=ADEMPIERE_DATA_PUMP_DIR DUMPFILE="$DATA_ENDPOINT"ExpDatFull_"$DATE".dmp LOGFILE="$DATA_ENDPOINT"ExpDatFull_"$DATE".log EXCLUDE=STATISTICS FULL=Y
