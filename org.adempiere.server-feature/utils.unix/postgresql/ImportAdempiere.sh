...
echo	Importing Adempiere DB from $ADEMPIERE_HOME/data/seed/Adempiere_pg.dmp
...
psql -h $ADEMPIERE_DB_SERVER -p $ADEMPIERE_DB_PORT -d $ADEMPIERE_DB_NAME -U $2 -f $ADEMPIERE_HOME/data/seed/Adempiere_pg.dmp
