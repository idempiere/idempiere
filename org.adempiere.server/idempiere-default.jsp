...
Version: 1.0
Description: Default Theme for IDempiere
Author: Zuhri Utama
...
<body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid gap-2 nav-inline-row">
              ...
              <div class="d-flex align-items-center gap-2 flex-shrink-0 ms-auto nav-controls">
                <button type="button" class="theme-toggle theme-toggle-sm btn btn-link p-0 d-lg-none" aria-label="Toggle light/dark theme" title="Toggle theme">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-2 d-flex justify-content-center align-items-center gap-2">
                    <%if(!Prop.getPropertyEscaped(Prop.SOC_FACEBOOK).equals("") && !Prop.getPropertyEscaped(Prop.SOC_FACEBOOK).equals("NONE")){%>
                        <a id="facebook" href="<%=Prop.getPropertyEscaped(Prop.SOC_FACEBOOK)%>" target="_blank" rel="noopener noreferrer" aria-label="Facebook" title="Facebook">
                    ...
                    <%} if(!Prop.getPropertyEscaped(Prop.SOC_TWITTER).equals("") && !Prop.getPropertyEscaped(Prop.SOC_TWITTER).equals("NONE")){%>
                        <a id="twitter" href="<%=Prop.getPropertyEscaped(Prop.SOC_TWITTER)%>" target="_blank" rel="noopener noreferrer" aria-label="Twitter" title="Twitter">
                    ...
                    <%} if(!Prop.getPropertyEscaped(Prop.SOC_LINKEDIN).equals("") && !Prop.getPropertyEscaped(Prop.SOC_LINKEDIN).equals("NONE")){%>
                        <a id="linkedin" href="<%=Prop.getPropertyEscaped(Prop.SOC_LINKEDIN)%>" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" title="LinkedIn">
                    ...
                    <%} if(!Prop.getPropertyEscaped(Prop.SOC_5).equals("") && !Prop.getPropertyEscaped(Prop.SOC_5).equals("NONE")){%>
                        <a id="soc5" href="<%=Prop.getPropertyEscaped(Prop.SOC_5)%>" target="_blank" rel="noopener noreferrer" aria-label="Social link 5">
                            <img name="img_soc5" src="<%=Prop.getImage("img_soc5.png")%>" border="0" alt="Social link 5"/>
                        </a>
                    <%} if(!Prop.getPropertyEscaped(Prop.SOC_6).equals("") && !Prop.getPropertyEscaped(Prop.SOC_6).equals("NONE")){%>
                        <a id="soc6" href="<%=Prop.getPropertyEscaped(Prop.SOC_6)%>" target="_blank" rel="noopener noreferrer" aria-label="Social link 6">
                            <img name="img_soc6" src="<%=Prop.getImage("img_soc6.png")%>" border="0" alt="Social link 6"/>
                        </a>
                    <%} if(!Prop.getPropertyEscaped(Prop.SOC_7).equals("") && !Prop.getPropertyEscaped(Prop.SOC_7).equals("NONE")){%>
                        <a id="soc7" href="<%=Prop.getPropertyEscaped(Prop.SOC_7)%>" target="_blank" rel="noopener noreferrer" aria-label="Social link 7">
                            <img name="img_soc7" src="<%=Prop.getImage("img_soc7.png")%>" border="0" alt="Social link 7"/>
                        </a>
                    <%}%>
                </div>
                <div class="col-12 col-md-5">
    ...
    <script src="/resources/bootstrap/bootstrap.bundle.min.js" type="text/javascript"></script>
    <script>
(function() {
    ...
    function apply(theme) {
        ...
        [ 'mainLogo', 'squareLogo' ].forEach(function(id) {
